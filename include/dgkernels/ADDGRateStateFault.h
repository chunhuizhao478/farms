 ...
 *
 */
class ADDGRateStateFault : public ADDGKernel
{
public:
  static InputParameters validParams();

  ADDGRateStateFault(const InputParameters & parameters);
...
protected:
  ...
  const MaterialProperty<Real> & _elasticity;
  const ADMaterialProperty<Real> & _slip;
};