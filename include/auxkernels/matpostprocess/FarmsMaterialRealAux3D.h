 ...
 */
class FarmsMaterialRealAux3D : public AuxKernel
{
public:
  static InputParameters validParams();

  FarmsMaterialRealAux3D(const InputParameters & parameters);
