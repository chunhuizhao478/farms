...
/**
 * TotalStressDivergenceTensor mostly copies from StressDivergence.  There are small changes to use
 ...
 */
class TotalStressDivergenceTensor : public JvarMapKernelInterface<ALEKernel>
{
public:
  static InputParameters validParams();

  TotalStressDivergenceTensor(const InputParameters & parameters);
...
protected:
  ...
  virtual Real computeQpOffDiagJacobianPorePressure(unsigned int jvar);
  ...
  const MaterialProperty<RankTwoTensor> & _stress_off_diag_jacobian;
};