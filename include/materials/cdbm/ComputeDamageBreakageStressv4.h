...
/**
 * ComputeDamageBreakageStressv4 put everything inside the computeQpstress without defining
 * additional functions
 
 */
class ComputeDamageBreakageStressv4 : public ComputeDamageBreakageStressBase
{
public:
  static InputParameters validParams();

  ComputeDamageBreakageStressv4(const InputParameters & parameters);
