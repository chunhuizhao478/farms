...
/**
 * ComputeDamageBreakageStressv3pressurev2 put everything inside the computeQpstress without defining
 * additional functions
 
 */
class ComputeDamageBreakageStressv3pressurev2 : public ComputeDamageBreakageStressBase
{
public:
  static InputParameters validParams();

  ComputeDamageBreakageStressv3pressurev2(const InputParameters & parameters);
