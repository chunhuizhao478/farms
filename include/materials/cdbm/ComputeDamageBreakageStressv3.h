...
/**
 * ComputeDamageBreakageStressv3 put everything inside the computeQpstress without defining
 * additional functions
 
 */
class ComputeDamageBreakageStressv3 : public ComputeDamageBreakageStressBase
{
public:
  static InputParameters validParams();

  ComputeDamageBreakageStressv3(const InputParameters & parameters);
