...
/**
 * ComputeDamageBreakageStressBorehole put everything inside the computeQpstress without defining
 * additional functions
 
 */
class ComputeDamageBreakageStressBorehole : public ComputeDamageBreakageStressBase
{
public:
  static InputParameters validParams();

  ComputeDamageBreakageStressBorehole(const InputParameters & parameters);
