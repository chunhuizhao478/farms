...
/**
 * ComputeGeneralDamageBreakageStressBase is the direct base class for stress calculator materials that may
 ...
 * from ComputeStressBase, which in turn directly derives from ComputeGeneralDamageBreakageStressBase).
 */
class ComputeGeneralDamageBreakageStressBase : public DerivativeMaterialInterface<Material>
{
public:
  static InputParameters validParams();

  ComputeGeneralDamageBreakageStressBase(const InputParameters & parameters);
...
protected:
  ...
  /// shear strain rate 
  MaterialProperty<Real> & _shear_strain;
