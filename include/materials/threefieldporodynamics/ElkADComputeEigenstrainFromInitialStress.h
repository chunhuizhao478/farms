 ...
 */
class ElkADComputeEigenstrainFromInitialStress : public ADComputeEigenstrainBase
{
public:
  static InputParameters validParams();

  ElkADComputeEigenstrainFromInitialStress(const InputParameters & parameters);
