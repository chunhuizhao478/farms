...
**/
class CZMComputeLocalTractionBaseRSF3D : public InterfaceMaterial
{
public:
  static InputParameters validParams();
  CZMComputeLocalTractionBaseRSF3D(const InputParameters & parameters);
...
protected:
  ...
  MaterialProperty<Real> & _alongfaultvel_dip_plus;
  MaterialProperty<Real> & _alongfaultvel_dip_minus;
  ...
  MaterialProperty<Real> & _alongfaultdisp_dip_plus;
  MaterialProperty<Real> & _alongfaultdisp_dip_minus;
  ...
  MaterialProperty<Real> & _sliprate_dip;
  MaterialProperty<Real> & _slip_dip;
  ...
  Real _Td_o; //initial dip traction
  ...
  MaterialProperty<Real> & _alongfaultvel_z_plus;
  MaterialProperty<Real> & _alongfaultvel_z_minus;
  ...
  MaterialProperty<Real> & _alongfaultdisp_z_plus;
  MaterialProperty<Real> & _alongfaultdisp_z_minus;
