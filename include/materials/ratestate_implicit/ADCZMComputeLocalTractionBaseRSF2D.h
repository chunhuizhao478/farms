 ...
 */
class ADCZMComputeLocalTractionBaseRSF2D : public InterfaceMaterial
{
public:
  static InputParameters validParams();
  ADCZMComputeLocalTractionBaseRSF2D(const InputParameters & parameters);
...
protected:
  ...
  ADMaterialProperty<Real> & _statevar; //state variable
  ADMaterialProperty<Real> & _sliprate; //slip rate

  ADReal _statevarini; //initial state variable
  ADReal _Vini;        //initial sliprate    
