...
/**
 * ComputeSmearedCrackingStressDebug computes the stress for a finite strain
 * material with smeared cracking
 */
class ComputeSmearedCrackingStressDebug : public ComputeMultipleInelasticStress
{
public:
  static InputParameters validParams();

  ComputeSmearedCrackingStressDebug(const InputParameters & parameters);
...
protected:
  ...
  MaterialProperty<Real> & _cracking_strain;
