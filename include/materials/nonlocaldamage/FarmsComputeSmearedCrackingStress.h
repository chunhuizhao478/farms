...
/**
 * FarmsComputeSmearedCrackingStress computes the stress for a finite strain
 * material with smeared cracking
 */
class FarmsComputeSmearedCrackingStress : public ComputeMultipleInelasticStress
{
public:
  static InputParameters validParams();

  FarmsComputeSmearedCrackingStress(const InputParameters & parameters);
