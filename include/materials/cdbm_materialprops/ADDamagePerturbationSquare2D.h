 ...
 */
class ADDamagePerturbationSquare2D : public ADMaterial
{
public:
  static InputParameters validParams();

  ADDamagePerturbationSquare2D(const InputParameters & parameters);
...
protected:
  ...
  ADMaterialProperty<Real> & _damage_perturbation;
  ...
  /// standard deviation used in apply damage value normal to the fault (exponential decay)
  Real _sigma;
