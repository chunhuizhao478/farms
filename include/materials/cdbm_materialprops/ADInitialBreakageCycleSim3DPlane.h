 ...
 */
class ADInitialBreakageCycleSim3DPlane : public ADMaterial
{
public:
  static InputParameters validParams();

  ADInitialBreakageCycleSim3DPlane(const InputParameters & parameters);
...
protected:
  ...
  ADMaterialProperty<Real> & _initial_breakage;
