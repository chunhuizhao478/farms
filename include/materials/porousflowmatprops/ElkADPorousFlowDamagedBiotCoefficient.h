...
/**
 * AD version of ElkPorousFlowDamagedBiotCoefficient.
 * Computes a damage-dependent Biot coefficient:
 *   alpha = 1 - K(d) / K_s
 ...
 *
 * Provides ADMaterialProperty<Real> named "biot_coefficient_damaged"
 */
class ElkADPorousFlowDamagedBiotCoefficient : public ADMaterial
{
public:
  static InputParameters validParams();

  ElkADPorousFlowDamagedBiotCoefficient(const InputParameters & parameters);
...
protected:
  ...
  ADMaterialProperty<Real> & _biot_coefficient_damaged;
};
