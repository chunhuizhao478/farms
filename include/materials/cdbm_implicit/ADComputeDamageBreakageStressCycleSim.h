...
/**
 * ADComputeDamageBreakageStressCycleSim computes the stress following linear elasticity theory (small
 * strains)
 */
//template <typename RankTwoTensor, typename RankFourTensor, typename Real>
class ADComputeDamageBreakageStressCycleSim : public ADComputeDamageBreakageStressBase
{
public:
  static InputParameters validParams();

  ADComputeDamageBreakageStressCycleSim(const InputParameters & parameters);
...
//typedef ADComputeDamageBreakageStressCycleSim<RankTwoTensor, RankFourTensor, Real>
//    ADComputeDamageBreakageStressCycleSim;
//typedef ADComputeDamageBreakageStressCycleSim<SymmetricRankTwoTensor, SymmetricRankFourTensor>
