...
/**
 * ADComputeSmallStrainDamageBreakageStress computes the stress following linear elasticity theory (small
 * strains)
 */
//template <typename RankTwoTensor, typename RankFourTensor, typename Real>
class ADComputeSmallStrainDamageBreakageStress : public ADComputeDamageBreakageStressBase
{
public:
  static InputParameters validParams();

  ADComputeSmallStrainDamageBreakageStress(const InputParameters & parameters);
