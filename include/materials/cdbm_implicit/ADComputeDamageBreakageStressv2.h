...
/**
 * ADComputeDamageBreakageStressv2 computes the stress following linear elasticity theory (small
 * strains)
 */
//template <typename RankTwoTensor, typename RankFourTensor, typename Real>
class ADComputeDamageBreakageStressv2 : public ADComputeDamageBreakageStressBase
{
public:
  static InputParameters validParams();

  ADComputeDamageBreakageStressv2(const InputParameters & parameters);
...
//typedef ADComputeDamageBreakageStressv2<RankTwoTensor, RankFourTensor, Real>
//    ADComputeDamageBreakageStressv2;
//typedef ADComputeDamageBreakageStressv2<SymmetricRankTwoTensor, SymmetricRankFourTensor>
