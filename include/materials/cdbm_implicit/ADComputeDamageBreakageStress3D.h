...
/**
 * ADComputeDamageBreakageStress3D computes the stress following linear elasticity theory (small
 * strains)
 */
//template <typename RankTwoTensor, typename RankFourTensor, typename Real>
class ADComputeDamageBreakageStress3D : public ADComputeDamageBreakageStressBase
{
public:
  static InputParameters validParams();

  ADComputeDamageBreakageStress3D(const InputParameters & parameters);
...
//typedef ADComputeDamageBreakageStress3D<RankTwoTensor, RankFourTensor, Real>
//    ADComputeDamageBreakageStress3D;
//typedef ADComputeDamageBreakageStress3D<SymmetricRankTwoTensor, SymmetricRankFourTensor>
