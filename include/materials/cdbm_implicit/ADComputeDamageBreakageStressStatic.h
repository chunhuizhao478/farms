...
/**
 * ADComputeDamageBreakageStressStatic computes the stress following linear elasticity theory (small
 * strains)
 */
//template <typename RankTwoTensor, typename RankFourTensor, typename Real>
class ADComputeDamageBreakageStressStatic : public ADComputeDamageBreakageStressBase
{
public:
  static InputParameters validParams();

  ADComputeDamageBreakageStressStatic(const InputParameters & parameters);
...
//typedef ADComputeDamageBreakageStressStatic<RankTwoTensor, RankFourTensor, Real>
//    ADComputeDamageBreakageStressStatic;
//typedef ADComputeDamageBreakageStressStatic<SymmetricRankTwoTensor, SymmetricRankFourTensor>
