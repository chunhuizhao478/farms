...
/**
 * ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev put everything inside the computeQpstress without defining
 * additional functions

 */
class ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev : public ComputeDamageBreakageStressBase3D
{
public:
  static InputParameters validParams();

  ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev(const InputParameters & parameters);
...
protected:
  ...
  /// old dilatancy function beta
  const MaterialProperty<Real> & _dilatancy_function_beta_old;
