...
/**
 * ComputeDamageBreakageStress3DStaticPureSolid put everything inside the computeQpstress without defining
 * additional functions

 */
class ComputeDamageBreakageStress3DStaticPureSolid : public ComputeDamageBreakageStressBase3D
{
public:
  static InputParameters validParams();

  ComputeDamageBreakageStress3DStaticPureSolid(const InputParameters & parameters);
