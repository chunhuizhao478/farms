...
/**
 * ComputeDamageBreakageStress3DSlipWeakeningVelocityStructureNonlocal put everything inside the computeQpstress without defining
 * additional functions
 
 */
class ComputeDamageBreakageStress3DSlipWeakeningVelocityStructureNonlocal : public ComputeDamageBreakageStressBase3D
{
public:
  static InputParameters validParams();

  ComputeDamageBreakageStress3DSlipWeakeningVelocityStructureNonlocal(const InputParameters & parameters);
