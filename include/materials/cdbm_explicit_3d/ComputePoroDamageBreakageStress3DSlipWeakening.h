...
/**
 * ComputePoroDamageBreakageStress3DSlipWeakening put everything inside the computeQpstress without defining
 * additional functions
 
 */
class ComputePoroDamageBreakageStress3DSlipWeakening : public ComputeDamageBreakageStressBase3D
{
public:
  static InputParameters validParams();

  ComputePoroDamageBreakageStress3DSlipWeakening(const InputParameters & parameters);
