...
/**
 * ComputeDamageBreakageStress3DTabularZonesNonlocal put everything inside the computeQpstress without defining
 * additional functions
 
 */
class ComputeDamageBreakageStress3DTabularZonesNonlocal : public ComputeDamageBreakageStressBase3D
{
public:
  static InputParameters validParams();

  ComputeDamageBreakageStress3DTabularZonesNonlocal(const InputParameters & parameters);
