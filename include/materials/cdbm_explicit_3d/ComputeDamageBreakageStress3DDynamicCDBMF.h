...
/**
 * ComputeDamageBreakageStress3DDynamicCDBMF put everything inside the computeQpstress without defining
 * additional functions
 
 */
class ComputeDamageBreakageStress3DDynamicCDBMF : public ComputeDamageBreakageStressBase3D
{
public:
  static InputParameters validParams();

  ComputeDamageBreakageStress3DDynamicCDBMF(const InputParameters & parameters);
