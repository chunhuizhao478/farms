...
/**
 * ComputeDamageBreakageStress3DDynamicCDBMDebug put everything inside the computeQpstress without defining
 * additional functions
 
 */
class ComputeDamageBreakageStress3DDynamicCDBMDebug : public ComputeDamageBreakageStressBase3D
{
public:
  static InputParameters validParams();

  ComputeDamageBreakageStress3DDynamicCDBMDebug(const InputParameters & parameters);
