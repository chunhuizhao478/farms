...
///   2) d(PK1)/d(F)
///
class ComputeLagrangianDamageBreakageStressPK2DiffusedPureSolid : public ComputeLagrangianStressPK1
{
public:
  static InputParameters validParams();
  ComputeLagrangianDamageBreakageStressPK2DiffusedPureSolid(const InputParameters & parameters);
