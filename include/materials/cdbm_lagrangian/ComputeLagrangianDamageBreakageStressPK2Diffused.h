...
///   2) d(PK1)/d(F)
///
class ComputeLagrangianDamageBreakageStressPK2Diffused : public ComputeLagrangianStressPK1
{
public:
  static InputParameters validParams();
  ComputeLagrangianDamageBreakageStressPK2Diffused(const InputParameters & parameters);
