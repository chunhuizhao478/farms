...
///   2) d(PK1)/d(F)
///
class ComputeLagrangianDamageBreakageStressPK2DiffusedDebug : public ComputeLagrangianStressPK1
{
public:
  static InputParameters validParams();
  ComputeLagrangianDamageBreakageStressPK2DiffusedDebug(const InputParameters & parameters);
