...
class ComputeLagrangianDamageBreakageStressPK2ModifiedFlowRule : public ComputeLagrangianStressPK1
{
public:
  static InputParameters validParams();
  ComputeLagrangianDamageBreakageStressPK2ModifiedFlowRule(const InputParameters & parameters);
...
protected:
  ...
  /// parameters of modified flow rule
