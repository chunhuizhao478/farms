...
class SlipWeakeningMultifaultsGeneralizedPropCSVnoslip : public CZMComputeLocalTractionTotalBaseSWF2D
{
public:
  static InputParameters validParams();
  SlipWeakeningMultifaultsGeneralizedPropCSVnoslip(const InputParameters & parameters);
