/* Only use over stress nucleation */
#pragma once

#include "CZMComputeLocalTractionTotalBase.h"

class SlipWeakeningMultifaultsOverStress3D : public CZMComputeLocalTractionTotalBase
{
public:
  static InputParameters validParams();
  SlipWeakeningMultifaultsOverStress3D(const InputParameters & parameters);
