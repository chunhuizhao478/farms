...
**/
class PoroCZMComputeLocalTractionBaseRSF2D : public InterfaceMaterial
{
public:
  static InputParameters validParams();
  PoroCZMComputeLocalTractionBaseRSF2D(const InputParameters & parameters);
...
protected:
  ...
  MaterialProperty<Real> & _dalongfaultdisp_strike_plus_tplusdt_dvf_strike_plus;
  MaterialProperty<Real> & _dalongfaultdisp_strike_plus_tplusdt_dvf_strike_minus;
  MaterialProperty<Real> & _dalongfaultdisp_strike_plus_tplusdt_dvf_normal_plus;
  MaterialProperty<Real> & _dalongfaultdisp_strike_plus_tplusdt_dvf_normal_minus;

  MaterialProperty<Real> & _dalongfaultdisp_strike_minus_tplusdt_dvf_strike_plus;
  MaterialProperty<Real> & _dalongfaultdisp_strike_minus_tplusdt_dvf_strike_minus;
  MaterialProperty<Real> & _dalongfaultdisp_strike_minus_tplusdt_dvf_normal_plus;
  MaterialProperty<Real> & _dalongfaultdisp_strike_minus_tplusdt_dvf_normal_minus;

  MaterialProperty<Real> & _dalongfaultdisp_normal_plus_tplusdt_dvf_strike_plus;
  MaterialProperty<Real> & _dalongfaultdisp_normal_plus_tplusdt_dvf_strike_minus;
  MaterialProperty<Real> & _dalongfaultdisp_normal_plus_tplusdt_dvf_normal_plus;
  MaterialProperty<Real> & _dalongfaultdisp_normal_plus_tplusdt_dvf_normal_minus;
  
  MaterialProperty<Real> & _dalongfaultdisp_normal_minus_tplusdt_dvf_strike_plus;
  MaterialProperty<Real> & _dalongfaultdisp_normal_minus_tplusdt_dvf_strike_minus;
  MaterialProperty<Real> & _dalongfaultdisp_normal_minus_tplusdt_dvf_normal_plus;
  MaterialProperty<Real> & _dalongfaultdisp_normal_minus_tplusdt_dvf_normal_minus;

  MaterialProperty<Real> & _dalongfaultdisp_strike_plus_tplusdt_dp_plus;
  MaterialProperty<Real> & _dalongfaultdisp_strike_plus_tplusdt_dp_minus;

  MaterialProperty<Real> & _dalongfaultdisp_strike_minus_tplusdt_dp_plus;
  MaterialProperty<Real> & _dalongfaultdisp_strike_minus_tplusdt_dp_minus;

  MaterialProperty<Real> & _dalongfaultdisp_normal_plus_tplusdt_dp_plus;
  MaterialProperty<Real> & _dalongfaultdisp_normal_plus_tplusdt_dp_minus;
  
  MaterialProperty<Real> & _dalongfaultdisp_normal_minus_tplusdt_dp_plus;
  MaterialProperty<Real> & _dalongfaultdisp_normal_minus_tplusdt_dp_minus;
};