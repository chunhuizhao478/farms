 ...
 */
class PoroRateStateInterfaceKernelGlobaly : public InterfaceKernel
{
public:
  static InputParameters validParams();
  PoroRateStateInterfaceKernelGlobaly(const InputParameters & parameters);
...
protected:
  ...
  const MaterialProperty<Real> & _dalongfaultdisp_normal_plus_tplusdt_dvf_strike_plus;
  const MaterialProperty<Real> & _dalongfaultdisp_normal_plus_tplusdt_dvf_strike_minus;
  const MaterialProperty<Real> & _dalongfaultdisp_normal_plus_tplusdt_dvf_normal_plus;
  const MaterialProperty<Real> & _dalongfaultdisp_normal_plus_tplusdt_dvf_normal_minus;
  const MaterialProperty<Real> & _dalongfaultdisp_normal_minus_tplusdt_dvf_strike_plus;
  const MaterialProperty<Real> & _dalongfaultdisp_normal_minus_tplusdt_dvf_strike_minus;
  const MaterialProperty<Real> & _dalongfaultdisp_normal_minus_tplusdt_dvf_normal_plus;
  const MaterialProperty<Real> & _dalongfaultdisp_normal_minus_tplusdt_dvf_normal_minus;

  // Derivatives with respect to pressure
  const MaterialProperty<Real> & _dalongfaultdisp_normal_plus_tplusdt_dp_plus;
  const MaterialProperty<Real> & _dalongfaultdisp_normal_plus_tplusdt_dp_minus;
  const MaterialProperty<Real> & _dalongfaultdisp_normal_minus_tplusdt_dp_plus;
  const MaterialProperty<Real> & _dalongfaultdisp_normal_minus_tplusdt_dp_minus;
