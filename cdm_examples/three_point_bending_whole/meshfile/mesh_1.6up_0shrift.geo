...
Point(10) = { 0.0140 - 0.001, 0.0032        ,   0, lc};
Point(11) = { 0.0140        , 0.0032 + 0.001,   0, lc};
Point(12) = { 0.0140 + 0.001, 0.0032        ,   0, lc};
Point(13) = { 0.0140        , 0.0032 - 0.001,   0, lc};

Point(14) = { 0.0140, 0.0011, 0, lc};
Point(15) = { 0.0140, 0.0032, 0, lc};
