...
#include "ADNonReflectDashpotBC3d.h"

registerMooseObject("farmsApp", ADNonReflectDashpotBC3d);

InputParameters
ADNonReflectDashpotBC3d::validParams()
{
...
ADNonReflectDashpotBC3d::ADNonReflectDashpotBC3d(const InputParameters & parameters)
  : ADIntegratedBC(parameters),
    ...
    _disp_y_dot(adCoupledDot("disp_y")),
    _disp_z_dot(adCoupledDot("disp_z")),
...
ADReal
ADNonReflectDashpotBC3d::computeQpResidual()
{
  std::vector<ADReal> velocity(3, 0.0);
