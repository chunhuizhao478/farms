...
#include "FluidDiffusion.h"

registerMooseObject("farmsApp", FluidDiffusion);

InputParameters
FluidDiffusion::validParams()
{
...
FluidDiffusion::FluidDiffusion(const InputParameters & parameters)
  : Kernel(parameters),
...
Real
FluidDiffusion::computeQpResidual()
{
...
Real
FluidDiffusion::computeQpJacobian()
{
