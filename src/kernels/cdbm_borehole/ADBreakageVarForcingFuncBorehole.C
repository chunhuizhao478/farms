...
#include "ADBreakageVarForcingFuncBorehole.h"

registerMooseObject("farmsApp", ADBreakageVarForcingFuncBorehole);

InputParameters
ADBreakageVarForcingFuncBorehole::validParams()
{
...
ADBreakageVarForcingFuncBorehole::ADBreakageVarForcingFuncBorehole(const InputParameters & parameters)
 : ADKernel(parameters),
...
ADReal
ADBreakageVarForcingFuncBorehole::computeQpResidual()
{ 
...
ADReal 
ADBreakageVarForcingFuncBorehole::computeAlphaCr(ADReal xi)
{
  ADReal alphacr;
  if ( xi < _xi_0 )
  {
