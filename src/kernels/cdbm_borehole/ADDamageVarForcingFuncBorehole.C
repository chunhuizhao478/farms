...
#include "ADDamageVarForcingFuncBorehole.h"

registerMooseObject("farmsApp", ADDamageVarForcingFuncBorehole);

InputParameters
ADDamageVarForcingFuncBorehole::validParams()
{
...
ADDamageVarForcingFuncBorehole::ADDamageVarForcingFuncBorehole(const InputParameters & parameters)
 : ADKernel(parameters),
...
ADReal
ADDamageVarForcingFuncBorehole::computeQpResidual()
{ 
