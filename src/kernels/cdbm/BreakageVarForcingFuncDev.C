...
BreakageVarForcingFuncDev::computeAlphaCr(Real xi)
{
  ...
  else if ( xi > _xi_0 && xi <= _xi_1 )
  {
    ...
    alphacr = ((xi*1.309515574611735e65-8.313800451932681e48*5.859186308785048e16-8.313800451932681e+48*pow(xi,3)*4.503599627370496e15+sqrt((8.313800451932681e48*4.846181140130635e48-4.630237479875695e97)*(xi*-1.357067791385416e+33-pow(xi,2)*1.70372240670674e33+pow(xi,3)*5.277485855387731e32+pow(xi,4)*2.4338891524382e32+pow(xi,6)*2.028240960365167e31+3.064441352049399e33)*(-6.950491450939705e-118))*5.364228152580211e58+pow(xi,3)*2.182525957686226e64-8.313800451932681e48*xi*2.702159776422298e16+2.839467818614573e65)*-3.515500562074967e63)/(xi*5.236288458670739e129-8.313800451932681e48*4.465332704310073e79-8.313800451932681e48*pow(xi,2)*2.948766926928636e80+pow(xi,2)*2.817371193870561e129-8.313800451932681e48*xi*5.480496947075617e80+4.266359479714755e128);
  }
  else if ( xi > _xi_1 && xi <= _xi_max )
  {
    ...
    //case1
    alphacr = 6.408e10/(8.313800451932681e48*1.907148945675009e-38+xi*(8.313800451932681e48*1.026136459894226e-38-4.972843159139813e10)-9.242389251950257e10);
  }
  else
  {
    std::cout<<"xi: "<<xi<<std::endl;
