...
InputParameters
FarmsConditionalEnableControl::validParams()
{
...
FarmsConditionalEnableControl::FarmsConditionalEnableControl(const InputParameters & parameters)
  : Control(parameters),
...
void
FarmsConditionalEnableControl::execute()
{

  // DO NOTHING
  if (_t < _dt) // skip the initial inactive step
    return;
