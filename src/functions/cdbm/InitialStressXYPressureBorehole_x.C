...
#include "InitialStressXYPressureBorehole_x.h"

registerMooseObject("farmsApp", InitialStressXYPressureBorehole_x);

InputParameters
InitialStressXYPressureBorehole_x::validParams()
{
  InputParameters params = Function::validParams();
  return params;
}

InitialStressXYPressureBorehole_x::InitialStressXYPressureBorehole_x(const InputParameters & parameters)
  : Function(parameters)
{
}

Real
InitialStressXYPressureBorehole_x::value(Real t, const Point & p) const
{
  ...
  //set & check threshold 
  Real threshold = 10e6; //10% of mean stress maximum
