...
#include "InitialStressXYPressureNetwork2.h"
#include <cmath>
...
registerMooseObject("farmsApp", InitialStressXYPressureNetwork2);

InputParameters
InitialStressXYPressureNetwork2::validParams()
{
...
InitialStressXYPressureNetwork2::InitialStressXYPressureNetwork2(const InputParameters & parameters)
  : Function(parameters),
...
*********************************************************************/
Real expint_network2(int n, Real x)
{
	int i,ii,nm1;
...
Real
InitialStressXYPressureNetwork2::value(Real t, const Point & p) const
{
