#include "ForcedRuptureTime.h"

registerMooseObject("farmsApp", ForcedRuptureTime);

InputParameters
ForcedRuptureTime::validParams()
{
...
ForcedRuptureTime::ForcedRuptureTime(const InputParameters & parameters)
  : Function(parameters),
...
Real
ForcedRuptureTime::value(Real /*t*/, const Point & p) const
{
