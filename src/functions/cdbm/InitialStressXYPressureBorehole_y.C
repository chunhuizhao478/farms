...
#include "InitialStressXYPressureBorehole_y.h"

registerMooseObject("farmsApp", InitialStressXYPressureBorehole_y);

InputParameters
InitialStressXYPressureBorehole_y::validParams()
{
  InputParameters params = Function::validParams();
  return params;
}

InitialStressXYPressureBorehole_y::InitialStressXYPressureBorehole_y(const InputParameters & parameters)
  : Function(parameters)
{
}

Real
InitialStressXYPressureBorehole_y::value(Real t, const Point & p) const
{
