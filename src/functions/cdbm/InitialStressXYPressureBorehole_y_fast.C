...
#include "InitialStressXYPressureBorehole_y_fast.h"

registerMooseObject("farmsApp", InitialStressXYPressureBorehole_y_fast);

InputParameters
InitialStressXYPressureBorehole_y_fast::validParams()
{
  InputParameters params = Function::validParams();
  return params;
}

InitialStressXYPressureBorehole_y_fast::InitialStressXYPressureBorehole_y_fast(const InputParameters & parameters)
  : Function(parameters)
{
}

Real
InitialStressXYPressureBorehole_y_fast::value(Real t, const Point & p) const
{
