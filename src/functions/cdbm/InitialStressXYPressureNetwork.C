...
#include "InitialStressXYPressureNetwork.h"
#include <cmath>
...
registerMooseObject("farmsApp", InitialStressXYPressureNetwork);

InputParameters
InitialStressXYPressureNetwork::validParams()
{
...
InitialStressXYPressureNetwork::InitialStressXYPressureNetwork(const InputParameters & parameters)
  : Function(parameters),
...
*********************************************************************/
Real expint_network(int n, Real x)
{
	int i,ii,nm1;
...
InitialStressXYPressureNetwork::value(Real t, const Point & p) const
{
  ...
  //compute R
  Real x_center = -1432.3; //208.7;
  Real y_center = 1481;    //-1200;
