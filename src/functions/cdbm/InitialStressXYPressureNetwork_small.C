...
#include "InitialStressXYPressureNetwork_small.h"
#include <cmath>
...
registerMooseObject("farmsApp", InitialStressXYPressureNetwork_small);

InputParameters
InitialStressXYPressureNetwork_small::validParams()
{
...
InitialStressXYPressureNetwork_small::InitialStressXYPressureNetwork_small(const InputParameters & parameters)
  : Function(parameters),
...
*********************************************************************/
Real expint_network3(int n, Real x)
{
	int i,ii,nm1;
...
Real
InitialStressXYPressureNetwork_small::value(Real t, const Point & p) const
{
  ...
  Real expIntz = expint_network3(1, z);
