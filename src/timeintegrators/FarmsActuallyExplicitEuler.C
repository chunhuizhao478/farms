...
registerMooseObject("farmsApp", FarmsActuallyExplicitEuler);

InputParameters
FarmsActuallyExplicitEuler::validParams()
{
  InputParameters params = FarmsExplicitTimeIntegrator::validParams();
...
FarmsActuallyExplicitEuler::FarmsActuallyExplicitEuler(const InputParameters & parameters)
  : FarmsExplicitTimeIntegrator(parameters), _constant_mass(getParam<bool>("use_constant_mass"))
{
}

void
FarmsActuallyExplicitEuler::computeTimeDerivatives()
{
  if (!_sys.solutionUDot())
    mooseError("FarmsActuallyExplicitEuler: Time derivative of solution (`u_dot`) is not stored. Please "
...
void
FarmsActuallyExplicitEuler::computeADTimeDerivatives(ADReal & ad_u_dot,
...
void
FarmsActuallyExplicitEuler::solve()
{
...
void
FarmsActuallyExplicitEuler::postResidual(NumericVector<Number> & residual)
{
  residual += *_Re_time;
