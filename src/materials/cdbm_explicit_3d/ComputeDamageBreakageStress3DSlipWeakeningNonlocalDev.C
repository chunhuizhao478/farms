...
// Dec 24th, 2025: add shear-induced dilatancy in the permenant strain evolution

#include "ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev.h"
#include "NestedSolve.h"
#include "FEProblem.h"
#include <type_traits>

registerMooseObject("farmsApp", ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev);

InputParameters
ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev::validParams()
{
...
ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev::ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev(const InputParameters & parameters)
  : ComputeDamageBreakageStressBase3D(parameters),
    ...
    _dilatancy_function_beta_old(getMaterialPropertyOldByName<Real>(_base_name + "dilatancy_function_beta")),
...
void
ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev::initialSetup()
{
...
void
ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev::initQpStatefulProperties()
{
...
void
ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev::computeQpStress()
{
  ...
  if (_step == 1 && !_app.isRestarting()){
    ...
    */
    ...
    if (_use_dilatancy)
    {
        ...
        _eta[_qp] = _eta_old[_qp] + _dilatancy_function_beta_old[_qp] * _C_g * std::pow(_B_old[_qp], _m1) * std::pow(sigma_d_norm, _m2) * _dt;
...
Real
ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev::computegammar()
{
...
std::vector<Real>
ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev::computecoefficients(Real gamma_damaged_r)
{
...
Real
ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev::alphacr_root1(Real xi, Real gamma_damaged_r) {
...
Real
ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev::alphacr_root2(Real xi, Real gamma_damaged_r) {
    return 2 * _shear_modulus_o / (gamma_damaged_r * (xi - 2 * _xi_0));
}

void
ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev::computeQpTangentModulus(RankFourTensor & tangent,
                                                      Real I1,
                                                      Real I2,
                                                      Real xi,
                                                      RankTwoTensor Ee,
...
void
ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev::setupInitial()
{
...
void
ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev::computeDeviatroicStrainRateTensor()
{
...
void
ComputeDamageBreakageStress3DSlipWeakeningNonlocalDev::computeStrainRateCd()
{
