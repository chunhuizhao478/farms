...
#include "ComputeDamageBreakageStress3DSlipWeakeningVelocityStructureNonlocal.h"
#include "NestedSolve.h"
#include "FEProblem.h"

registerMooseObject("farmsApp", ComputeDamageBreakageStress3DSlipWeakeningVelocityStructureNonlocal);
...
ComputeDamageBreakageStress3DSlipWeakeningVelocityStructureNonlocal::ComputeDamageBreakageStress3DSlipWeakeningVelocityStructureNonlocal(const InputParameters & parameters)
...
void
ComputeDamageBreakageStress3DSlipWeakeningVelocityStructureNonlocal::initialSetup()
{
...
void
ComputeDamageBreakageStress3DSlipWeakeningVelocityStructureNonlocal::initQpStatefulProperties()
{
...
std::vector<Real>
ComputeDamageBreakageStress3DSlipWeakeningVelocityStructureNonlocal::computecoefficients(Real gamma_damaged_r)
{
...
void
ComputeDamageBreakageStress3DSlipWeakeningVelocityStructureNonlocal::setupInitial()
{
...
void
ComputeDamageBreakageStress3DSlipWeakeningVelocityStructureNonlocal::computeDeviatroicStrainRateTensor()
{
...
ComputeDamageBreakageStress3DSlipWeakeningVelocityStructureNonlocal::computeStrainRateCd()
{
  ...
  if (_deviatroic_strain_rate_old[_qp] < _strain_rate_hat){
    _Cd_mat[_qp] = 0.0; //if deviatoric strain rate is less than strain_rate_hat, Cd = Cd_hat //otherwise the velocity is nonzero near surface
  }
  else{
