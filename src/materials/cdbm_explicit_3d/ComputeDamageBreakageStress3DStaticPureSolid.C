...
#include "ComputeDamageBreakageStress3DStaticPureSolid.h"
#include "NestedSolve.h"
#include "FEProblem.h"

registerMooseObject("farmsApp", ComputeDamageBreakageStress3DStaticPureSolid);

InputParameters
ComputeDamageBreakageStress3DStaticPureSolid::validParams()
{
...
ComputeDamageBreakageStress3DStaticPureSolid::ComputeDamageBreakageStress3DStaticPureSolid(const InputParameters & parameters)
...
void
ComputeDamageBreakageStress3DStaticPureSolid::initialSetup()
{
...
void
ComputeDamageBreakageStress3DStaticPureSolid::initQpStatefulProperties()
{
...
void
ComputeDamageBreakageStress3DStaticPureSolid::computeQpStress()
{
...
Real
ComputeDamageBreakageStress3DStaticPureSolid::computegammar()
{
...
std::vector<Real>
ComputeDamageBreakageStress3DStaticPureSolid::computecoefficients(Real gamma_damaged_r)
{
...
Real
ComputeDamageBreakageStress3DStaticPureSolid::alphacr_root1(Real xi, Real gamma_damaged_r) {
...
Real
ComputeDamageBreakageStress3DStaticPureSolid::alphacr_root2(Real xi, Real gamma_damaged_r) {
    return 2 * _shear_modulus_o / (gamma_damaged_r * (xi - 2 * _xi_0));
}

void
ComputeDamageBreakageStress3DStaticPureSolid::computeQpTangentModulus(RankFourTensor & tangent,
                                                      Real I1,
                                                      Real I2,
                                                      Real xi,
                                                      RankTwoTensor Ee,
...
// void
// ComputeDamageBreakageStress3DStaticPureSolid::setupInitial()
// {
...
void
ComputeDamageBreakageStress3DStaticPureSolid::computeDeviatroicStrainRateTensor()
{
...
void
ComputeDamageBreakageStress3DStaticPureSolid::computeStrainRateCd()
{
