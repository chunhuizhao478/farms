...
#include "ComputeDamageBreakageStress3Doverstress.h"
#include "NestedSolve.h"
#include "FEProblem.h"

registerMooseObject("farmsApp", ComputeDamageBreakageStress3Doverstress);

InputParameters
ComputeDamageBreakageStress3Doverstress::validParams()
{ 
...
ComputeDamageBreakageStress3Doverstress::ComputeDamageBreakageStress3Doverstress(const InputParameters & parameters)
...
void
ComputeDamageBreakageStress3Doverstress::initialSetup()
{
...
void
ComputeDamageBreakageStress3Doverstress::initQpStatefulProperties()
{
...
void
ComputeDamageBreakageStress3Doverstress::computeQpStress()
{ 
...
///Function: deltaij
Real 
ComputeDamageBreakageStress3Doverstress::deltaij(int i, int j)
{
...
Real 
ComputeDamageBreakageStress3Doverstress::epsilonij(int i, 
                                       int j,
                                       Real eps11e_in,
                                       Real eps22e_in,
                                       Real eps12e_in,
...
Real 
ComputeDamageBreakageStress3Doverstress::grad_alpha(int i, 
                                          Real alpha_grad_x,
                                          Real alpha_grad_y,
                                          Real alpha_grad_z)
{ 
...
Real 
ComputeDamageBreakageStress3Doverstress::computeStressComps(int i, 
                                                int j,
                                                Real xi_in,
                                                Real I1_in,
                                                Real B_in,
...
void
ComputeDamageBreakageStress3Doverstress::setupInitial()
{
