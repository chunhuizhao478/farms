...
#include "ComputeDamageBreakageStress3DDynamicCDBMF.h"
#include "NestedSolve.h"
#include "FEProblem.h"

registerMooseObject("farmsApp", ComputeDamageBreakageStress3DDynamicCDBMF);

InputParameters
ComputeDamageBreakageStress3DDynamicCDBMF::validParams()
{ 
...
ComputeDamageBreakageStress3DDynamicCDBMF::ComputeDamageBreakageStress3DDynamicCDBMF(const InputParameters & parameters)
...
void
ComputeDamageBreakageStress3DDynamicCDBMF::initialSetup()
{
...
void
ComputeDamageBreakageStress3DDynamicCDBMF::initQpStatefulProperties()
{
...
void
ComputeDamageBreakageStress3DDynamicCDBMF::computeQpStress()
{ 
...
Real 
ComputeDamageBreakageStress3DDynamicCDBMF::computegammar()
{
...
std::vector<Real>
ComputeDamageBreakageStress3DDynamicCDBMF::computecoefficients(Real gamma_damaged_r)
{
...
Real 
ComputeDamageBreakageStress3DDynamicCDBMF::alphacr_root1(Real xi, Real gamma_damaged_r) {
...
Real 
ComputeDamageBreakageStress3DDynamicCDBMF::alphacr_root2(Real xi, Real gamma_damaged_r) {
    return 2 * _shear_modulus_o / (gamma_damaged_r * (xi - 2 * _xi_0));
}

void
ComputeDamageBreakageStress3DDynamicCDBMF::computePrincipalStrainAndOrientation(
...
// void
// ComputeDamageBreakageStress3DDynamicCDBMF::computeQpTangentModulus(Real I1, 
//                                                        Real I2, 
//                                                        Real xi, 
//                                                        Real B,
