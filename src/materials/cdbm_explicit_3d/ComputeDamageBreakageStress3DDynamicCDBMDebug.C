...
#include "ComputeDamageBreakageStress3DDynamicCDBMDebug.h"
#include "NestedSolve.h"
#include "FEProblem.h"

registerMooseObject("farmsApp", ComputeDamageBreakageStress3DDynamicCDBMDebug);

InputParameters
ComputeDamageBreakageStress3DDynamicCDBMDebug::validParams()
{ 
...
ComputeDamageBreakageStress3DDynamicCDBMDebug::ComputeDamageBreakageStress3DDynamicCDBMDebug(const InputParameters & parameters)
...
void
ComputeDamageBreakageStress3DDynamicCDBMDebug::initialSetup()
{
...
void
ComputeDamageBreakageStress3DDynamicCDBMDebug::initQpStatefulProperties()
{
...
void
ComputeDamageBreakageStress3DDynamicCDBMDebug::computeQpStress()
{ 
...
Real 
ComputeDamageBreakageStress3DDynamicCDBMDebug::computegammar()
{
...
std::vector<Real>
ComputeDamageBreakageStress3DDynamicCDBMDebug::computecoefficients(Real gamma_damaged_r)
{
...
Real 
ComputeDamageBreakageStress3DDynamicCDBMDebug::alphacr_root1(Real xi, Real gamma_damaged_r) {
...
Real 
ComputeDamageBreakageStress3DDynamicCDBMDebug::alphacr_root2(Real xi, Real gamma_damaged_r) {
    return 2 * _shear_modulus_o / (gamma_damaged_r * (xi - 2 * _xi_0));
}

void
ComputeDamageBreakageStress3DDynamicCDBMDebug::computeQpTangentModulus(RankFourTensor & tangent, 
                                                      Real I1, 
                                                      Real I2, 
                                                      Real xi, 
                                                      RankTwoTensor Ee)
...
void
ComputeDamageBreakageStress3DDynamicCDBMDebug::computeCrackStrainAndOrientation(
...
void
ComputeDamageBreakageStress3DDynamicCDBMDebug::updateSolidBulkCompliance()
{
...
void
ComputeDamageBreakageStress3DDynamicCDBMDebug::updatePermeabilityForCracking()
{
...
void
ComputeDamageBreakageStress3DDynamicCDBMDebug::HeavisideFunction(Real & x)
{
  if (x > 0.0)
    x = 1.0;
  else
