...
#include "ComputeDamageBreakageStress3DTabularZonesNonlocal.h"
#include "NestedSolve.h"
#include "FEProblem.h"

registerMooseObject("farmsApp", ComputeDamageBreakageStress3DTabularZonesNonlocal);

InputParameters
ComputeDamageBreakageStress3DTabularZonesNonlocal::validParams()
{ 
...
ComputeDamageBreakageStress3DTabularZonesNonlocal::ComputeDamageBreakageStress3DTabularZonesNonlocal(const InputParameters & parameters)
...
void
ComputeDamageBreakageStress3DTabularZonesNonlocal::initialSetup()
{
...
void
ComputeDamageBreakageStress3DTabularZonesNonlocal::initQpStatefulProperties()
{
...
void
ComputeDamageBreakageStress3DTabularZonesNonlocal::computeQpStress()
{ 
...
Real 
ComputeDamageBreakageStress3DTabularZonesNonlocal::computegammar()
{
...
std::vector<Real>
ComputeDamageBreakageStress3DTabularZonesNonlocal::computecoefficients(Real gamma_damaged_r)
{
...
Real 
ComputeDamageBreakageStress3DTabularZonesNonlocal::alphacr_root1(Real xi, Real gamma_damaged_r) {
...
Real 
ComputeDamageBreakageStress3DTabularZonesNonlocal::alphacr_root2(Real xi, Real gamma_damaged_r) {
    return 2 * _shear_modulus_o / (gamma_damaged_r * (xi - 2 * _xi_0));
}

void
ComputeDamageBreakageStress3DTabularZonesNonlocal::computeQpTangentModulus(RankFourTensor & tangent, 
                                                      Real I1, 
                                                      Real I2, 
                                                      Real xi, 
                                                      RankTwoTensor Ee,
...
void
ComputeDamageBreakageStress3DTabularZonesNonlocal::setupInitial()
{
...
void
ComputeDamageBreakageStress3DTabularZonesNonlocal::computeDeviatroicStrainRateTensor()
{
...
void 
ComputeDamageBreakageStress3DTabularZonesNonlocal::computeStrainRateCd()
{
