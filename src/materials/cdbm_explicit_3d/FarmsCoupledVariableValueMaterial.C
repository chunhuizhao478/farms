...
#include "FarmsCoupledVariableValueMaterial.h"

#include "metaphysicl/raw_type.h"

registerMooseObject("farmsApp", FarmsCoupledVariableValueMaterial);
registerMooseObject("farmsApp", ADFarmsCoupledVariableValueMaterial);

template <bool is_ad>
InputParameters
FarmsCoupledVariableValueMaterialTempl<is_ad>::validParams()
{
...
template <bool is_ad>
FarmsCoupledVariableValueMaterialTempl<is_ad>::FarmsCoupledVariableValueMaterialTempl(
...
template <bool is_ad>
void
FarmsCoupledVariableValueMaterialTempl<is_ad>::computeQpProperties()
{
  if (is_ad)
...
template class FarmsCoupledVariableValueMaterialTempl<false>;
template class FarmsCoupledVariableValueMaterialTempl<true>;
