...
#include "ADComputeDamageBreakageStressDev.h"
...
//template <typename RankTwoTensor, typename R4, typename ADReal>
ADComputeDamageBreakageStressDev::ADComputeDamageBreakageStressDev(
...
//template <typename RankTwoTensor, typename R4, typename ADReal>
void
ADComputeDamageBreakageStressDev::initialSetup()
{
...
//template <typename RankTwoTensor, typename R4, typename ADReal>
void
ADComputeDamageBreakageStressDev::computeQpStress()
{
...
void
ADComputeDamageBreakageStressDev::setupInitial()
{
