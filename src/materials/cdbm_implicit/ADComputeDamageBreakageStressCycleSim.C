...
#include "ADComputeDamageBreakageStressCycleSim.h"
...
InputParameters
ADComputeDamageBreakageStressCycleSim::validParams()
{
...
//template <typename RankTwoTensor, typename R4, typename ADReal>
ADComputeDamageBreakageStressCycleSim::ADComputeDamageBreakageStressCycleSim(
...
//template <typename RankTwoTensor, typename R4, typename ADReal>
void
ADComputeDamageBreakageStressCycleSim::initialSetup()
{
...
//template <typename RankTwoTensor, typename R4, typename ADReal>
void
ADComputeDamageBreakageStressCycleSim::computeQpStress()
{
...
void
ADComputeDamageBreakageStressCycleSim::setupInitial()
{
  ...
  if (y_coord >= 0-1*1.0 and y_coord <= 0+1*1.0){
