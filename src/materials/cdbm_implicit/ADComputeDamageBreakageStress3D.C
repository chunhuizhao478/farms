...
#include "ADComputeDamageBreakageStress3D.h"
#include "RankTwoTensor.h"
#include "RankFourTensor.h"
#include "SymmetricRankTwoTensor.h"
#include "SymmetricRankFourTensor.h"

registerMooseObject("farmsApp", ADComputeDamageBreakageStress3D);
//registerMooseObject("farmsApp", ADSymmetricDamageBreakageStress); //?

//template <typename RankTwoTensor, typename R4, typename ADReal>
InputParameters
ADComputeDamageBreakageStress3D::validParams()
{
...
//template <typename RankTwoTensor, typename R4, typename ADReal>
ADComputeDamageBreakageStress3D::ADComputeDamageBreakageStress3D(
...
//template <typename RankTwoTensor, typename R4, typename ADReal>
void
ADComputeDamageBreakageStress3D::initialSetup()
{
...
//template <typename RankTwoTensor, typename R4, typename ADReal>
void
ADComputeDamageBreakageStress3D::computeQpStress()
{
...
ADComputeDamageBreakageStress3D::setupInitial()
{
  ...
  ADReal sts13_init = stress_initial(0,2);
  ADReal sts23_init = stress_initial(1,2);
