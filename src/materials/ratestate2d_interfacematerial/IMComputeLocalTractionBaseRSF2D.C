...
InputParameters
IMComputeLocalTractionBaseRSF2D::validParams()
{
...
IMComputeLocalTractionBaseRSF2D::IMComputeLocalTractionBaseRSF2D(const InputParameters & parameters)
...
void
IMComputeLocalTractionBaseRSF2D::initQpStatefulProperties()
{
...
void
IMComputeLocalTractionBaseRSF2D::computeQpProperties()
{
