...
#include "SlipWeakeningFrictionczm2d.h"
#include "InterfaceKernel.h"

registerMooseObject("farmsApp", SlipWeakeningFrictionczm2d);

InputParameters
SlipWeakeningFrictionczm2d::validParams()
{
...
SlipWeakeningFrictionczm2d::SlipWeakeningFrictionczm2d(const InputParameters & parameters)
...
void
SlipWeakeningFrictionczm2d::computeInterfaceTractionAndDerivatives()
{
