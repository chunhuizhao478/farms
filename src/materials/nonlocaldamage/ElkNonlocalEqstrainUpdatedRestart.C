...
#include "ElkNonlocalEqstrainUpdatedRestart.h"
#include "FEProblem.h"

registerMooseObject("farmsApp", ElkNonlocalEqstrainUpdatedRestart);

InputParameters
ElkNonlocalEqstrainUpdatedRestart::validParams()
{
...
ElkNonlocalEqstrainUpdatedRestart::ElkNonlocalEqstrainUpdatedRestart(const InputParameters & parameters)
  : Material(parameters),
...
//
void
ElkNonlocalEqstrainUpdatedRestart::initQpStatefulProperties()
{
  // _eqstrain_nonlocal[_qp] = _eqstrain_nonlocal_initial[_qp];
}

void
ElkNonlocalEqstrainUpdatedRestart::computeQpProperties()
{
