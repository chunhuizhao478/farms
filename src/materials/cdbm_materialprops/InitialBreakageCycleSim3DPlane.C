 ...
 */
registerMooseObject("farmsApp", InitialBreakageCycleSim3DPlane);
...
InitialBreakageCycleSim3DPlane::validParams()
{
  ...
  params.addParam<bool>("use_breakage_perturb", false,
  ...
  params.addParam<MaterialPropertyName>(
      "breakage_perturb",
      "",
      "Coupled material property for damage perturbation. Must be specified if use_breakage_perturb = true.");
...
InitialBreakageCycleSim3DPlane::InitialBreakageCycleSim3DPlane(const InputParameters & parameters)
  : Material(parameters),
    ...
    _use_breakage_perturb(getParam<bool>("use_breakage_perturb")),
    _breakage_perturbation(_use_breakage_perturb ? &getMaterialProperty<Real>("breakage_perturbation") : nullptr),
...
InitialBreakageCycleSim3DPlane::computeQpProperties()
{
  ...
  if (_use_breakage_perturb)
    alpha_o += (*_breakage_perturbation)[_qp];
