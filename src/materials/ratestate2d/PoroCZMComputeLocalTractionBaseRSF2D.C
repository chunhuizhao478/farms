...
InputParameters
PoroCZMComputeLocalTractionBaseRSF2D::validParams()
{
...
PoroCZMComputeLocalTractionBaseRSF2D::PoroCZMComputeLocalTractionBaseRSF2D(const InputParameters & parameters)
  : InterfaceMaterial(parameters),
    ...
    _dalongfaultdisp_strike_plus_tplusdt_dvf_strike_plus(declarePropertyByName<Real>("dalongfaultdisp_strike_plus_tplusdt_dvf_strike_plus")),
    _dalongfaultdisp_strike_plus_tplusdt_dvf_strike_minus(declarePropertyByName<Real>("dalongfaultdisp_strike_plus_tplusdt_dvf_strike_minus")),
    _dalongfaultdisp_strike_plus_tplusdt_dvf_normal_plus(declarePropertyByName<Real>("dalongfaultdisp_strike_plus_tplusdt_dvf_normal_plus")),
    _dalongfaultdisp_strike_plus_tplusdt_dvf_normal_minus(declarePropertyByName<Real>("dalongfaultdisp_strike_plus_tplusdt_dvf_normal_minus")),
    _dalongfaultdisp_strike_minus_tplusdt_dvf_strike_plus(declarePropertyByName<Real>("dalongfaultdisp_strike_minus_tplusdt_dvf_strike_plus")),
    _dalongfaultdisp_strike_minus_tplusdt_dvf_strike_minus(declarePropertyByName<Real>("dalongfaultdisp_strike_minus_tplusdt_dvf_strike_minus")),
    _dalongfaultdisp_strike_minus_tplusdt_dvf_normal_plus(declarePropertyByName<Real>("dalongfaultdisp_strike_minus_tplusdt_dvf_normal_plus")),
    _dalongfaultdisp_strike_minus_tplusdt_dvf_normal_minus(declarePropertyByName<Real>("dalongfaultdisp_strike_minus_tplusdt_dvf_normal_minus")),
    _dalongfaultdisp_normal_plus_tplusdt_dvf_strike_plus(declarePropertyByName<Real>("dalongfaultdisp_normal_plus_tplusdt_dvf_strike_plus")),
    _dalongfaultdisp_normal_plus_tplusdt_dvf_strike_minus(declarePropertyByName<Real>("dalongfaultdisp_normal_plus_tplusdt_dvf_strike_minus")),
    _dalongfaultdisp_normal_plus_tplusdt_dvf_normal_plus(declarePropertyByName<Real>("dalongfaultdisp_normal_plus_tplusdt_dvf_normal_plus")),
    _dalongfaultdisp_normal_plus_tplusdt_dvf_normal_minus(declarePropertyByName<Real>("dalongfaultdisp_normal_plus_tplusdt_dvf_normal_minus")),
    _dalongfaultdisp_normal_minus_tplusdt_dvf_strike_plus(declarePropertyByName<Real>("dalongfaultdisp_normal_minus_tplusdt_dvf_strike_plus")),
    _dalongfaultdisp_normal_minus_tplusdt_dvf_strike_minus(declarePropertyByName<Real>("dalongfaultdisp_normal_minus_tplusdt_dvf_strike_minus")),
    _dalongfaultdisp_normal_minus_tplusdt_dvf_normal_plus(declarePropertyByName<Real>("dalongfaultdisp_normal_minus_tplusdt_dvf_normal_plus")),
    _dalongfaultdisp_normal_minus_tplusdt_dvf_normal_minus(declarePropertyByName<Real>("dalongfaultdisp_normal_minus_tplusdt_dvf_normal_minus")),
    _dalongfaultdisp_strike_plus_tplusdt_dp_plus(declarePropertyByName<Real>("dalongfaultdisp_strike_plus_tplusdt_dp_plus")),
    _dalongfaultdisp_strike_plus_tplusdt_dp_minus(declarePropertyByName<Real>("dalongfaultdisp_strike_plus_tplusdt_dp_minus")),
    _dalongfaultdisp_strike_minus_tplusdt_dp_plus(declarePropertyByName<Real>("dalongfaultdisp_strike_minus_tplusdt_dp_plus")),
    _dalongfaultdisp_strike_minus_tplusdt_dp_minus(declarePropertyByName<Real>("dalongfaultdisp_strike_minus_tplusdt_dp_minus")),
    _dalongfaultdisp_normal_plus_tplusdt_dp_plus(declarePropertyByName<Real>("dalongfaultdisp_normal_plus_tplusdt_dp_plus")),
    _dalongfaultdisp_normal_plus_tplusdt_dp_minus(declarePropertyByName<Real>("dalongfaultdisp_normal_plus_tplusdt_dp_minus")),
    _dalongfaultdisp_normal_minus_tplusdt_dp_plus(declarePropertyByName<Real>("dalongfaultdisp_normal_minus_tplusdt_dp_plus")),
    _dalongfaultdisp_normal_minus_tplusdt_dp_minus(declarePropertyByName<Real>("dalongfaultdisp_normal_minus_tplusdt_dp_minus"))
{
}

void
PoroCZMComputeLocalTractionBaseRSF2D::initQpStatefulProperties()
{
...
void
PoroCZMComputeLocalTractionBaseRSF2D::computeQpProperties()
{
