...
InputParameters
CZMComputeLocalTractionBaseRSF3D::validParams()
{
...
CZMComputeLocalTractionBaseRSF3D::CZMComputeLocalTractionBaseRSF3D(const InputParameters & parameters)
  : InterfaceMaterial(parameters),
    ...
    _alongfaultvel_dip_plus(declarePropertyByName<Real>("alongfaultvel_dip_plus")),
    _alongfaultvel_dip_minus(declarePropertyByName<Real>("alongfaultvel_dip_minus")),
    ...
    _alongfaultdisp_dip_plus(declarePropertyByName<Real>("alongfaultdisp_dip_plus")),
    _alongfaultdisp_dip_minus(declarePropertyByName<Real>("alongfaultdisp_dip_minus")),
    ...
    _sliprate_dip(declarePropertyByName<Real>("sliprate_dip")),
    _slip_dip(declarePropertyByName<Real>("slip_dip")),
    ...
    _alongfaultvel_z_plus(declarePropertyByName<Real>("alongfaultvel_z_plus")),
    _alongfaultvel_z_minus(declarePropertyByName<Real>("alongfaultvel_z_minus")),
    ...
    _alongfaultdisp_z_plus(declarePropertyByName<Real>("alongfaultdisp_z_plus")),
    _alongfaultdisp_z_minus(declarePropertyByName<Real>("alongfaultdisp_z_minus"))
{
}

void
CZMComputeLocalTractionBaseRSF3D::initQpStatefulProperties()
{
  _interface_traction[_qp] = 0;

  _alongfaultvel_strike_plus[_qp] = _Vini * 0.5;
  _alongfaultvel_strike_minus[_qp] = -1 * _Vini * 0.5;
  
  _alongfaultvel_normal_plus[_qp] = 0;
  _alongfaultvel_normal_minus[_qp] = 0;

  _alongfaultvel_dip_plus[_qp] = 0;
  _alongfaultvel_dip_minus[_qp] = 0;
  ...
  _alongfaultdisp_z_plus[_qp] = 0;
  _alongfaultdisp_z_minus[_qp] = 0;

}

void
CZMComputeLocalTractionBaseRSF3D::computeQpProperties()
{
