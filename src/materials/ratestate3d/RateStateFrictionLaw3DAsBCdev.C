...
#include "RateStateFrictionLaw3DAsBCdev.h"
...
registerMooseObject("farmsApp", RateStateFrictionLaw3DAsBCdev);

InputParameters
RateStateFrictionLaw3DAsBCdev::validParams()
{ 
...
RateStateFrictionLaw3DAsBCdev::RateStateFrictionLaw3DAsBCdev(const InputParameters & parameters)
...
void
RateStateFrictionLaw3DAsBCdev::computeInterfaceTractionAndDerivatives()
{   
