...
#include "DiffusedDamageBreakageMaterialMainAppExplicit.h"
 ...
 */
registerMooseObject("farmsApp", DiffusedDamageBreakageMaterialMainAppExplicit);

InputParameters
DiffusedDamageBreakageMaterialMainAppExplicit::validParams()
{
...
DiffusedDamageBreakageMaterialMainAppExplicit::DiffusedDamageBreakageMaterialMainAppExplicit(const InputParameters & parameters)
  : Material(parameters),
  //declare properties
  //--------------------------------------------------------------//
  ...
  _Dp_old(getMaterialPropertyOldByName<RankTwoTensor>(getParam<std::string>("base_name") + "plastic_strain_rate")),
  _Dp_older(getMaterialPropertyOlderByName<RankTwoTensor>(getParam<std::string>("base_name") + "plastic_strain_rate")),
  _phi_p_old(getMaterialPropertyOldByName<Real>(getParam<std::string>("base_name") + "plastic_porosity")),
  _phi_p_older(getMaterialPropertyOlderByName<Real>(getParam<std::string>("base_name") + "plastic_porosity")),
  //---------------------------------------------------------------//
  //use spatial cg
...
//
void 
DiffusedDamageBreakageMaterialMainAppExplicit::initQpStatefulProperties()
{
...
void
DiffusedDamageBreakageMaterialMainAppExplicit::computeQpProperties()
{
  /* compute _gamma_damaged_r_mat */
  computegammar();
...
void 
DiffusedDamageBreakageMaterialMainAppExplicit::computegammar()
{
...
void
DiffusedDamageBreakageMaterialMainAppExplicit::updatedamagebreakage()
{
...
void 
DiffusedDamageBreakageMaterialMainAppExplicit::updatemodulus()
{
...
void
DiffusedDamageBreakageMaterialMainAppExplicit::computecoefficients()
{
  //compute xi_1
...
void
DiffusedDamageBreakageMaterialMainAppExplicit::updateporosolid()
{
...
void
DiffusedDamageBreakageMaterialMainAppExplicit::updateporogranular()
{
  // Get strain invariants 
  Real I1 = _I1[_qp];
  Real xi = _xi[_qp];
  ...
  Real dporosity_pdt_older = (1 - _phi_p_older[_qp]) * _Dp_older[_qp].trace();

  Real porosity_p = _phi_p_older[_qp] + 0.5 * _dt * (3 * dporosity_pdt_old - dporosity_pdt_older );
...
Real 
DiffusedDamageBreakageMaterialMainAppExplicit::alphacr_root1(Real xi) {
...
void
DiffusedDamageBreakageMaterialMainAppExplicit::buildLmatrix()
{
...
void 
DiffusedDamageBreakageMaterialMainAppExplicit::acceptspatialCg()
{
  _C_g[_qp] = _cg_aux[_qp];
}

void 
DiffusedDamageBreakageMaterialMainAppExplicit::usestatevar()
{
