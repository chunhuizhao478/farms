...
#include "DiffusedDamageBreakageMaterialMainAppPureSolid.h"
 ...
 */
registerMooseObject("farmsApp", DiffusedDamageBreakageMaterialMainAppPureSolid);

InputParameters
DiffusedDamageBreakageMaterialMainAppPureSolid::validParams()
{
...
DiffusedDamageBreakageMaterialMainAppPureSolid::DiffusedDamageBreakageMaterialMainAppPureSolid(const InputParameters & parameters)
  : Material(parameters),
  //declare properties
  //--------------------------------------------------------------//
...
//
void 
DiffusedDamageBreakageMaterialMainAppPureSolid::initQpStatefulProperties()
{
...
void
DiffusedDamageBreakageMaterialMainAppPureSolid::computeQpProperties()
{
  /* compute _gamma_damaged_r_mat */
  computegammar();
...
void 
DiffusedDamageBreakageMaterialMainAppPureSolid::computegammar()
{
...
void
DiffusedDamageBreakageMaterialMainAppPureSolid::updatedamagebreakage()
{
...
void 
DiffusedDamageBreakageMaterialMainAppPureSolid::updatemodulus()
{
...
void
DiffusedDamageBreakageMaterialMainAppPureSolid::computecoefficients()
{
  //compute xi_1
...
Real 
DiffusedDamageBreakageMaterialMainAppPureSolid::alphacr_root1(Real xi) {
...
void
DiffusedDamageBreakageMaterialMainAppPureSolid::buildLmatrix()
{
...
void 
DiffusedDamageBreakageMaterialMainAppPureSolid::acceptspatialCg()
{
  _C_g[_qp] = _cg_aux[_qp];
}

void 
DiffusedDamageBreakageMaterialMainAppPureSolid::usestatevar()
{
