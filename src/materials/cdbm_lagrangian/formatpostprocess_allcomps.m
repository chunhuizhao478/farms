...
folderPath = './tangents_formatted_allcomps';  % Specify the path to your folder
...
for num = 1:size(nums,1)
    ...
    %
    out_names = append('./tangents_formatted_allcomps/out_jacobian_',num_str,'_formatted.txt');
    writematrix(v,out_names);
end
%check files are identical
compareFiles('./tangents_formatted_allcomps/out_jacobian_1122_formatted.txt', ...
             './tangents_formatted_allcomps/out_jacobian_2211_formatted.txt');
