...
#include "ComputeLagrangianDamageBreakageStressPK2DiffusedPureSolid.h"


registerMooseObject("farmsApp", ComputeLagrangianDamageBreakageStressPK2DiffusedPureSolid);

InputParameters
ComputeLagrangianDamageBreakageStressPK2DiffusedPureSolid::validParams()
{
  InputParameters params = ComputeLagrangianStressPK1::validParams();
  return params;
}

ComputeLagrangianDamageBreakageStressPK2DiffusedPureSolid::ComputeLagrangianDamageBreakageStressPK2DiffusedPureSolid(const InputParameters & parameters)
...
//
void
ComputeLagrangianDamageBreakageStressPK2DiffusedPureSolid::initQpStatefulProperties()
{
...
void
ComputeLagrangianDamageBreakageStressPK2DiffusedPureSolid::computeQpPK1Stress()
{
...
void
ComputeLagrangianDamageBreakageStressPK2DiffusedPureSolid::computeQpPK2Stress()
{
  /* Evaluate Fp */
...
RankTwoTensor
ComputeLagrangianDamageBreakageStressPK2DiffusedPureSolid::computeQpFp()
{
...
void
ComputeLagrangianDamageBreakageStressPK2DiffusedPureSolid::computeQpTangentModulus(RankFourTensor & tangent, 
                                                                  Real I1, 
                                                                  Real I2, 
                                                                  Real xi, 
                                                                  RankTwoTensor Ee)
...
void 
ComputeLagrangianDamageBreakageStressPK2DiffusedPureSolid::computeDmatrix()
{
...
void
ComputeLagrangianDamageBreakageStressPK2DiffusedPureSolid::computeDeviatroicStrainRateTensor()
{
  //Compute D matrix
  computeDmatrix();
