...
ComputeGeneralDamageBreakageStressBase::ComputeGeneralDamageBreakageStressBase(const InputParameters & parameters)
...
void
ComputeGeneralDamageBreakageStressBase::initQpStatefulProperties()
{
...
void
ComputeGeneralDamageBreakageStressBase::computeQpProperties()
{
  computeQpStress();
...
// void
// ComputeGeneralDamageBreakageStressBase::computeInitialStrain()
// {
