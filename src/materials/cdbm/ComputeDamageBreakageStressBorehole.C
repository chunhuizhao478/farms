...
#include "ComputeDamageBreakageStressBorehole.h"
...
registerMooseObject("farmsApp", ComputeDamageBreakageStressBorehole);

InputParameters
ComputeDamageBreakageStressBorehole::validParams()
{ 
...
ComputeDamageBreakageStressBorehole::ComputeDamageBreakageStressBorehole(const InputParameters & parameters)
...
void
ComputeDamageBreakageStressBorehole::initialSetup()
{
...
void
ComputeDamageBreakageStressBorehole::computeQpStress()
{ 
...
///Function: deltaij
Real 
ComputeDamageBreakageStressBorehole::deltaij(int i, int j)
{
...
Real 
ComputeDamageBreakageStressBorehole::epsilonij(int i, 
                                       int j,
                                       Real eps11e_in,
                                       Real eps22e_in,
                                       Real eps12e_in,
...
Real 
ComputeDamageBreakageStressBorehole::grad_alpha(int i, 
                                          Real alpha_grad_x,
                                          Real alpha_grad_y)
{ 
  //take alpha grad
...
Real 
ComputeDamageBreakageStressBorehole::computeStressComps(int i, 
                                                int j,
                                                Real xi_in,
                                                Real I1_in,
                                                Real B_in,
...
void
ComputeDamageBreakageStressBorehole::setupInitial()
{
