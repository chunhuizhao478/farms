...
#include "ComputeDamageBreakageStress.h"
...
registerMooseObject("farmsApp", ComputeDamageBreakageStress);

InputParameters
ComputeDamageBreakageStress::validParams()
{ 
...
ComputeDamageBreakageStress::ComputeDamageBreakageStress(const InputParameters & parameters)
...
void
ComputeDamageBreakageStress::initialSetup()
{
...
void
ComputeDamageBreakageStress::computeQpStress()
{ 
...
///Function: deltaij
Real 
ComputeDamageBreakageStress::deltaij(int i, int j)
{
...
Real 
ComputeDamageBreakageStress::epsilonij(int i, 
                                       int j,
                                       Real eps11e_in,
                                       Real eps22e_in,
                                       Real eps12e_in)
...
void
ComputeDamageBreakageStress::setupInitial()
{
