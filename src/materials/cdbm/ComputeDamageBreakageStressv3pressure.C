...
#include "ComputeDamageBreakageStressv3pressure.h"
...
registerMooseObject("farmsApp", ComputeDamageBreakageStressv3pressure);

InputParameters
ComputeDamageBreakageStressv3pressure::validParams()
{ 
...
ComputeDamageBreakageStressv3pressure::ComputeDamageBreakageStressv3pressure(const InputParameters & parameters)
...
void
ComputeDamageBreakageStressv3pressure::initialSetup()
{
...
void
ComputeDamageBreakageStressv3pressure::computeQpStress()
{ 
  ...
  if (_t == 0.0)
  {
    ...
    if (_fe_problem.getCurrentExecuteOnFlag()=="LINEAR"){
      ...
      */
      ...
      //pressure taken as negative values
                          ...
                          NestedSolve::Jacobian<> & jacobian)
      {
          ...
          jacobian(3,2) = pow(B,_m1)*_C_g*_dt*_m2*((nu*(B*(((3*_a3*(4*minus_eps12e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e) + ((_a1*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr)) + B*(((3*_a3*(4*minus_eps12e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e) + ((_a1*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr)) + (B - 1)*((gamma_damaged*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)) - (gamma_damaged*(4*minus_eps12e)*(minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) + (B - 1)*((gamma_damaged*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)) - (gamma_damaged*(4*minus_eps12e)*(minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))))/3 + (B*(((3*_a3*(4*minus_eps12e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e) + ((_a1*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr)))/3 - (2*B*(((3*_a3*(4*minus_eps12e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e) + ((_a1*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr)))/3 + ((B - 1)*((gamma_damaged*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)) - (gamma_damaged*(4*minus_eps12e)*(minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))))/3 - (2*(B - 1)*((gamma_damaged*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)) - (gamma_damaged*(4*minus_eps12e)*(minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))))/3)*pow((B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 - (_effec_sts_coeff*_pressure_neg)/3 - (2*B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 + (nu*(2*_effec_sts_coeff*_pressure_neg + B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) + B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) - (B - 1)*((2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e) + (lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) - (B - 1)*((2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e) + (lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr))))/3 - ((B - 1)*((2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e) + (lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 + (2*(B - 1)*((2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e) + (lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3, _m2 - 1);
...
///Function: deltaij
Real 
ComputeDamageBreakageStressv3pressure::deltaij(int i, int j)
{
...
Real 
ComputeDamageBreakageStressv3pressure::epsilonij(int i, 
                                       int j,
                                       Real eps11e_in,
                                       Real eps22e_in,
                                       Real eps12e_in)
...
/// Function: grad_alpha
Real 
ComputeDamageBreakageStressv3pressure::grad_alpha(int i, 
                                          Real alpha_grad_x,
                                          Real alpha_grad_y)
{ 
  //take alpha grad
...
Real 
ComputeDamageBreakageStressv3pressure::computeStressComps(int i, 
                                                int j,
                                                Real xi_in,
                                                Real I1_in,
                                                Real B_in,
...
void
ComputeDamageBreakageStressv3pressure::setupInitial()
{
