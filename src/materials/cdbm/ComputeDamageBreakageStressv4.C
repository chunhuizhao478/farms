...
v4: correct system solve along z direction
  ...
  if (_t == 0.0)
  {
    ...
    //if (_fe_problem.getCurrentExecuteOnFlag()=="LINEAR"){
      ...
      */
      ...
      //1.Compute sigma_ij
      Real sigma_11 = computeStressComps(1, 1, xi_out, I1_out, B_out, lambda_out, gamma_damaged_out, shear_modulus_out, eps11e_out, eps22e_out, eps12e_out, eps33e_out, alpha_grad_x, alpha_grad_y, D);
      Real sigma_22 = computeStressComps(2, 2, xi_out, I1_out, B_out, lambda_out, gamma_damaged_out, shear_modulus_out, eps11e_out, eps22e_out, eps12e_out, eps33e_out, alpha_grad_x, alpha_grad_y, D);
      Real sigma_12 = computeStressComps(1, 2, xi_out, I1_out, B_out, lambda_out, gamma_damaged_out, shear_modulus_out, eps11e_out, eps22e_out, eps12e_out, eps33e_out, alpha_grad_x, alpha_grad_y, D);
      Real sigma_33 = computeStressComps(3, 3, xi_out, I1_out, B_out, lambda_out, gamma_damaged_out, shear_modulus_out, eps11e_out, eps22e_out, eps12e_out, eps33e_out, alpha_grad_x, alpha_grad_y, D);
