...
#include "ComputeDamageBreakageStressv4.h"
...
registerMooseObject("farmsApp", ComputeDamageBreakageStressv4);

InputParameters
ComputeDamageBreakageStressv4::validParams()
{ 
  ...
  params.addParam<Real>(             "D",           1.0, "coefficient of alpha gradient");
...
ComputeDamageBreakageStressv4::ComputeDamageBreakageStressv4(const InputParameters & parameters)
...
void
ComputeDamageBreakageStressv4::initialSetup()
{
...
void
ComputeDamageBreakageStressv4::computeQpStress()
{ 
    ...
    if (_fe_problem.getCurrentExecuteOnFlag()=="LINEAR"){
      ...
      */
                          ...
                          NestedSolve::Jacobian<> & jacobian)
      {
          ...
          Real I1 = eps11e + eps22e;
          Real I2 = eps11e * eps11e + eps22e * eps22e + 2 * eps12e * eps12e;
          Real xi = I1 / sqrt(I2);
          ...
          Real minus_eps_tr = minus_eps11e + minus_eps22e;
          Real minus_epse_I2 = pow(minus_eps11e,2) + 2*pow(minus_eps12e,2) + pow(minus_eps22e,2);
          jacobian(0,0) = pow(B,_m1)*_C_g*_dt*_m2*pow((B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 - (2*B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 + (2*((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1))/3 - (((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1))/3 + (nu*(B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) + B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1)))/3,_m2 - 1)*((B*((minus_eps22e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps11e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 + ((B - 1)*(lambda - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 - (2*(B - 1)*(lambda + 2*shear_modulus - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e) + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 + (nu*(B*((minus_eps22e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps11e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + (B - 1)*(lambda - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + (B - 1)*(lambda + 2*shear_modulus - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e) + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + B*((minus_eps11e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps11e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 - 2*_a0 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr) - (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))))/3 - (2*B*((minus_eps11e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps11e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 - 2*_a0 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr) - (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5)))/3) + 1;
          jacobian(0,1) = pow(B,_m1)*_C_g*_dt*_m2*pow((B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 - (2*B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 + (2*((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1))/3 - (((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1))/3 + (nu*(B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) + B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1)))/3,_m2 - 1)*(((B - 1)*(lambda + 2*shear_modulus - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e) + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 - (2*(B - 1)*(lambda - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 - (2*B*((minus_eps11e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps22e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 + (nu*(B*((minus_eps11e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps22e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + (B - 1)*(lambda - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + (B - 1)*(lambda + 2*shear_modulus - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e) + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + B*((minus_eps22e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps22e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 - 2*_a0 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr) - (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))))/3 + (B*((minus_eps22e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps22e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 - 2*_a0 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr) - (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5)))/3);
          jacobian(0,2) = pow(B,_m1)*_C_g*_dt*_m2*pow((B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 - (2*B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 + (2*((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1))/3 - (((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1))/3 + (nu*(B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) + B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1)))/3,_m2 - 1)*((B*(((_a1*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + ((3*_a3*(4*minus_eps12e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e)))/3 - (2*B*(((_a1*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + ((3*_a3*(4*minus_eps12e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e)))/3 - (2*(B - 1)*((gamma_damaged*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)) - (gamma_damaged*(4*minus_eps12e)*(minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))))/3 + ((B - 1)*((gamma_damaged*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)) - (gamma_damaged*(4*minus_eps12e)*(minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))))/3 + (nu*(B*(((_a1*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + ((3*_a3*(4*minus_eps12e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e)) + B*(((_a1*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + ((3*_a3*(4*minus_eps12e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e)) + (B - 1)*((gamma_damaged*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)) - (gamma_damaged*(4*minus_eps12e)*(minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) + (B - 1)*((gamma_damaged*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)) - (gamma_damaged*(4*minus_eps12e)*(minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))))/3);
          jacobian(1,0) = pow(B,_m1)*_C_g*_dt*_m2*pow((B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 - (2*B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 - (((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1))/3 + (2*((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1))/3 + (nu*(B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) + B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1)))/3,_m2 - 1)*(((B - 1)*(lambda + 2*shear_modulus - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e) + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 - (2*(B - 1)*(lambda - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 - (2*B*((minus_eps22e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps11e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 + (nu*(B*((minus_eps22e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps11e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + (B - 1)*(lambda - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + (B - 1)*(lambda + 2*shear_modulus - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e) + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + B*((minus_eps11e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps11e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 - 2*_a0 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr) - (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))))/3 + (B*((minus_eps11e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps11e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 - 2*_a0 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr) - (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5)))/3);
          jacobian(1,1) = pow(B,_m1)*_C_g*_dt*_m2*pow((B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 - (2*B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 - (((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1))/3 + (2*((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1))/3 + (nu*(B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) + B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1)))/3,_m2 - 1)*((B*((minus_eps11e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps22e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 + ((B - 1)*(lambda - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 - (2*(B - 1)*(lambda + 2*shear_modulus - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e) + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 + (nu*(B*((minus_eps11e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps22e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + (B - 1)*(lambda - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + (B - 1)*(lambda + 2*shear_modulus - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e) + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + B*((minus_eps22e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps22e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 - 2*_a0 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr) - (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))))/3 - (2*B*((minus_eps22e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps22e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 - 2*_a0 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr) - (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5)))/3) + 1;
          jacobian(1,2) = pow(B,_m1)*_C_g*_dt*_m2*pow((B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 - (2*B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 - (((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1))/3 + (2*((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1))/3 + (nu*(B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) + B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1)))/3,_m2 - 1)*((B*(((_a1*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + ((3*_a3*(4*minus_eps12e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e)))/3 - (2*B*(((_a1*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + ((3*_a3*(4*minus_eps12e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e)))/3 + ((B - 1)*((gamma_damaged*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)) - (gamma_damaged*(4*minus_eps12e)*(minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))))/3 - (2*(B - 1)*((gamma_damaged*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)) - (gamma_damaged*(4*minus_eps12e)*(minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))))/3 + (nu*(B*(((_a1*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + ((3*_a3*(4*minus_eps12e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e)) + B*(((_a1*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + ((3*_a3*(4*minus_eps12e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e)) + (B - 1)*((gamma_damaged*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)) - (gamma_damaged*(4*minus_eps12e)*(minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) + (B - 1)*((gamma_damaged*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)) - (gamma_damaged*(4*minus_eps12e)*(minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))))/3);
          jacobian(2,0) = pow(B,_m1)*_C_g*_dt*_m2*pow((B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 + (B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 - (((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1))/3 - (((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1))/3 + (nu*(B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) + B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1)))/3 + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(B - 1)*(minus_eps12e) - B*(2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps12e),_m2 - 1)*((B*((minus_eps22e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps11e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 + ((B - 1)*(lambda - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 + ((B - 1)*(lambda + 2*shear_modulus - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e) + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 + (nu*(B*((minus_eps22e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps11e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + (B - 1)*(lambda - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + (B - 1)*(lambda + 2*shear_modulus - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e) + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + B*((minus_eps11e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps11e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 - 2*_a0 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr) - (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))))/3 + (B*((minus_eps11e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps11e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 - 2*_a0 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps11e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr) - (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5)))/3 - (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(B - 1)*(minus_eps12e) - B*(minus_eps12e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps11e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))));
          jacobian(2,1) = pow(B,_m1)*_C_g*_dt*_m2*pow((B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 + (B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 - (((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1))/3 - (((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1))/3 + (nu*(B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) + B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1)))/3 + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(B - 1)*(minus_eps12e) - B*(2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps12e),_m2 - 1)*((B*((minus_eps11e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps22e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 + ((B - 1)*(lambda - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 + ((B - 1)*(lambda + 2*shear_modulus - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e) + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)))/3 + (nu*(B*((minus_eps11e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps22e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + (B - 1)*(lambda - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + (B - 1)*(lambda + 2*shear_modulus - ((gamma_damaged*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) - (gamma_damaged*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)))*(minus_eps_tr) + (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e) + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr)) + B*((minus_eps22e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps22e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 - 2*_a0 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr) - (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))))/3 + (B*((minus_eps22e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps22e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) - 2*_a2 - 2*_a0 + ((3*_a3)/pow(minus_epse_I2,0.5) - (_a1*pow(minus_epse_I2,0.5))/pow(minus_eps_tr,2.0) + (_a1*(2*minus_eps22e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr) - (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5)))/3 - (gamma_damaged/pow(minus_epse_I2,0.5) - (gamma_damaged*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(B - 1)*(minus_eps12e) - B*(minus_eps12e)*(_a1/pow(minus_epse_I2,0.5) - (3*_a3*pow(minus_eps_tr,2.0))/pow(minus_epse_I2,1.5) + (3*_a3*(2*minus_eps22e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(2*minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))));
          jacobian(2,2) = pow(B,_m1)*_C_g*_dt*_m2*pow((B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 + (B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)))/3 - (((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1))/3 - (((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1))/3 + (nu*(B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps11e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) + B*((2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps22e) - ((3*_a3*(minus_eps_tr))/pow(minus_epse_I2,0.5) - 2*_a2 + (_a1*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr)) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps11e))*(B - 1) - ((lambda + (gamma_damaged*pow(minus_epse_I2,0.5))/(minus_eps_tr))*(minus_eps_tr) + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(minus_eps22e))*(B - 1)))/3 + (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(B - 1)*(minus_eps12e) - B*(2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5))*(minus_eps12e),_m2 - 1)*((B*(((_a1*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + ((3*_a3*(4*minus_eps12e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e)))/3 - (2*shear_modulus + (gamma_damaged*(minus_eps_tr))/pow(minus_epse_I2,0.5))*(B - 1) + (B*(((_a1*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + ((3*_a3*(4*minus_eps12e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e)))/3 + B*(2*_a0 - (_a1*(minus_eps_tr))/pow(minus_epse_I2,0.5) + (_a3*pow(minus_eps_tr,3.0))/pow(minus_epse_I2,1.5)) + ((B - 1)*((gamma_damaged*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)) - (gamma_damaged*(4*minus_eps12e)*(minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))))/3 + ((B - 1)*((gamma_damaged*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)) - (gamma_damaged*(4*minus_eps12e)*(minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))))/3 + (nu*(B*(((_a1*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + ((3*_a3*(4*minus_eps12e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps11e)) + B*(((_a1*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)*(minus_eps_tr)) - (3*_a3*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps_tr) + ((3*_a3*(4*minus_eps12e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps22e)) + (B - 1)*((gamma_damaged*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)) - (gamma_damaged*(4*minus_eps12e)*(minus_eps11e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) + (B - 1)*((gamma_damaged*(4*minus_eps12e))/(2*pow(minus_epse_I2,0.5)) - (gamma_damaged*(4*minus_eps12e)*(minus_eps22e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))))/3 - B*((3*_a3*(4*minus_eps12e)*pow(minus_eps_tr,3.0))/(2*pow(minus_epse_I2,2.5)) - (_a1*(4*minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5)))*(minus_eps12e) + (gamma_damaged*(B - 1)*(4*minus_eps12e)*(minus_eps12e)*(minus_eps_tr))/(2*pow(minus_epse_I2,1.5))) + 1;
      };   

      NestedSolve solver;
      NestedSolve::Value<> solution(3);
      solution << 0, 0, 0;
      ...
      */
      ...
      Real I1_out = eps11e_out + eps22e_out;
      Real I2_out = eps11e_out * eps11e_out + eps22e_out * eps22e_out + 2 * eps12e_out * eps12e_out;
...
///Function: deltaij
Real 
ComputeDamageBreakageStressv4::deltaij(int i, int j)
{
...
Real 
ComputeDamageBreakageStressv4::epsilonij(int i, 
                                       int j,
                                       Real eps11e_in,
                                       Real eps22e_in,
                                       Real eps12e_in)
...
/// Function: grad_alpha
Real 
ComputeDamageBreakageStressv4::grad_alpha(int i, 
                                          Real alpha_grad_x,
                                          Real alpha_grad_y)
{ 
  //take alpha grad
...
Real 
ComputeDamageBreakageStressv4::computeStressComps(int i, 
                                                int j,
                                                Real xi_in,
                                                Real I1_in,
                                                Real B_in,
...
void
ComputeDamageBreakageStressv4::setupInitial()
{
