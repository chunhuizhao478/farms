...
#include "FarmsPorousFlowDamagedBiotModulus.h"

registerMooseObject("farmsApp", FarmsPorousFlowDamagedBiotModulus);

InputParameters
FarmsPorousFlowDamagedBiotModulus::validParams()
{
...
FarmsPorousFlowDamagedBiotModulus::FarmsPorousFlowDamagedBiotModulus(const InputParameters & parameters)
...
void
FarmsPorousFlowDamagedBiotModulus::initQpStatefulProperties()
{
...
void
FarmsPorousFlowDamagedBiotModulus::computeQpProperties()
{
