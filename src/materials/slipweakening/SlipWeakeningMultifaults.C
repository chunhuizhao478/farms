...
#include "SlipWeakeningMultifaults.h"
#include "InterfaceKernel.h"

registerMooseObject("farmsApp", SlipWeakeningMultifaults);

InputParameters
SlipWeakeningMultifaults::validParams()
{
...
SlipWeakeningMultifaults::SlipWeakeningMultifaults(const InputParameters & parameters)
