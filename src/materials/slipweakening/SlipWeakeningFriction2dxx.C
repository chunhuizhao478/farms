...
#include "SlipWeakeningFriction2dxx.h"
#include "InterfaceKernel.h"

//User-Specific App name
registerMooseObject("farmsApp", SlipWeakeningFriction2dxx);

InputParameters
SlipWeakeningFriction2dxx::validParams()
{
...
SlipWeakeningFriction2dxx::SlipWeakeningFriction2dxx(const InputParameters & parameters)
...
void
SlipWeakeningFriction2dxx::computeInterfaceTractionAndDerivatives()
{   
  ...
  //Compute node mass
  Real M = _density[_qp] * area * 166.6667; 
