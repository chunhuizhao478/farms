...
#include "SlipWeakeningMultifaultsGeneralizedPropCSVnoslip.h"
#include "InterfaceKernel.h"

registerMooseObject("farmsApp", SlipWeakeningMultifaultsGeneralizedPropCSVnoslip);

InputParameters
SlipWeakeningMultifaultsGeneralizedPropCSVnoslip::validParams()
{
...
SlipWeakeningMultifaultsGeneralizedPropCSVnoslip::SlipWeakeningMultifaultsGeneralizedPropCSVnoslip(const InputParameters & parameters)
...
void
SlipWeakeningMultifaultsGeneralizedPropCSVnoslip::computeInterfaceTractionAndDerivatives()
{   
   ...
   traction(0) = T2+T2_o; 
   traction(1) = 0;  //always 0 in this case
   traction(2) = 0;
