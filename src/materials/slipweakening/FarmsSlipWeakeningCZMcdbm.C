...
#include "FarmsSlipWeakeningCZMcdbm.h"
registerMooseObject("farmsApp", FarmsSlipWeakeningCZMcdbm);

InputParameters
FarmsSlipWeakeningCZMcdbm::validParams()
{
...
FarmsSlipWeakeningCZMcdbm::FarmsSlipWeakeningCZMcdbm(const InputParameters & parameters)
...
void
FarmsSlipWeakeningCZMcdbm::initQpStatefulProperties()
{
...
Real
FarmsSlipWeakeningCZMcdbm::computeTractionAndDisplacements()
{ 
...
RealTensorValue
FarmsSlipWeakeningCZMcdbm::computeTractionDerivatives()
{ 
