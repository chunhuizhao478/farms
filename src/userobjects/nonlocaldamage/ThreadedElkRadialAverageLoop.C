...
ThreadedElkRadialAverageLoop::ThreadedElkRadialAverageLoop(ElkRadialAverage & green) : _radavg(green) {}

// Splitting Constructor
ThreadedElkRadialAverageLoop::ThreadedElkRadialAverageLoop(const ThreadedElkRadialAverageLoop & x,
                                                     Threads::split /*split*/)
  : _radavg(x._radavg)
{
}
...
void
ThreadedElkRadialAverageLoop::operator()(const QPDataRange & qpdata_range)
{
