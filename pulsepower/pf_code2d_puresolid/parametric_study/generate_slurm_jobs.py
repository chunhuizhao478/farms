#!/usr/bin/env python3
"""
SLURM Job Generator for Parametric Studies
...
Usage:
    # Generate job files for all cases
...
# For porousflow: pulsepower/pf_code2d_porousflow/parametric_study
RELATIVE_STUDY_PATH = "pulsepower/pf_code2d_puresolid/parametric_study"
