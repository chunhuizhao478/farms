...
# Run the simulation
ibrun ./farms-opt -i /scratch/10024/zhaochun/projects/farms_cdms/pulsepower/pf_code2d_puresolid/parametric_study/case_cf1_domain2x/elasticity.i --allow-unused
