...
// Use second-order (quadratic) elements for Taylor-Hood formulation
Mesh.ElementOrder = 2;
Mesh.SecondOrderLinear = 0;  // Use curved elements (nodes on actual geometry)

// Characteristic lengths
lc0 = 0.0004; // super-fine near hole
lc = 0.0004;  // fine transition
lc2 = 0.0004;  // coarse outer
