...
[Mesh]
 ...
 []
  ...
  [Executioner]
    ...
    # Improved PETSc options for second-order elements
    ...
    line_search = 'bt'  # Enable backtracking line search for robustness
    l_max_its = 200
    nl_max_its = 30
    nl_rel_tol = 1e-6   # Relaxed relative tolerance
    nl_abs_tol = 1e-8   # Relaxed absolute tolerance
    l_tol = 1e-5

    automatic_scaling = true  # Important for mixed-order elements
  []
...
[AuxKernels]
  [fluid_elastic_energy]
      ...
      # Use the strain variables already output by the strain material
