#!/bin/bash
#SBATCH -J case_pp4_domain5x_elasticity        # Job name
#SBATCH -o case_pp4_domain5x_elasticity.o%j    # Name of stdout output file
#SBATCH -e case_pp4_domain5x_elasticity.e%j    # Name of stderr error file
