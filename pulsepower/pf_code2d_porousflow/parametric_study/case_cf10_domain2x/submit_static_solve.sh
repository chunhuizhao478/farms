#!/bin/bash
#SBATCH -J case_cf10_domain2x_static_solve        # Job name
#SBATCH -o case_cf10_domain2x_static_solve.o%j    # Name of stdout output file
#SBATCH -e case_cf10_domain2x_static_solve.e%j    # Name of stderr error file
