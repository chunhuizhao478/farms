...
cd /scratch1/10024/zhaochun/projects/farms_cdms/pulsepower/pf_code2d_porousflow/parametric_study/case_pp2_domain5x
...
echo "--------------------------------------------------------------------------------"
echo "Input file: /scratch1/10024/zhaochun/projects/farms_cdms/pulsepower/pf_code2d_porousflow/parametric_study/case_pp2_domain5x/static_solve.i"
echo "Start time: $(date)"
echo ""

ibrun /scratch/10024/zhaochun/projects/farms_cdms/farms-opt -i /scratch1/10024/zhaochun/projects/farms_cdms/pulsepower/pf_code2d_porousflow/parametric_study/case_pp2_domain5x/static_solve.i --allow-unused
...
echo "--------------------------------------------------------------------------------"
echo "Input file: /scratch1/10024/zhaochun/projects/farms_cdms/pulsepower/pf_code2d_porousflow/parametric_study/case_pp2_domain5x/elasticity.i"
echo "Start time: $(date)"
echo ""

ibrun /scratch/10024/zhaochun/projects/farms_cdms/farms-opt -i /scratch1/10024/zhaochun/projects/farms_cdms/pulsepower/pf_code2d_porousflow/parametric_study/case_pp2_domain5x/elasticity.i --allow-unused
