# =============================================================================
# PF-CZM Static Solve Elasticity Main Application with Porous Flow Coupling
...
[MultiApps]
  [fracture]
    ...
    input_files = fracturehf_static_pfczm.i
...
[BCs]
  [./Pressure]
    # Static solve - no pulse loading on inner hole
    [static_pressure_top]
      boundary = top
...
[Materials]
  ...
  # =============================================================================
  # Elasticity Model with Porous Flow Coupling
