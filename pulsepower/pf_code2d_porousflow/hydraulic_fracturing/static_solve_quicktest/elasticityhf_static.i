...
[MultiApps]
  [fracture]
    ...
    input_files = fracturehf_static.i
...
[AuxKernels]
  ...
  [../]
  ### PorousFlow Aux ###
  #effective permeability - unified across all blocks
...
[Functions]
  [func_tri_pulse]
    ...
    base_factor = 8000
    peak_pressure = 5e6 #if peak pressure is specified, the depth variation is ignored
  []
[]
...
#    start_time = 0
#    end_time = 2e-6 # must be > dt (2e-6) to ensure first step is steady (exclusive upper bound)
#  []
#[]
...
[Outputs]
  [./exodus]
    ...
    show = 'disp_x disp_y pp elastic_strain_00 elastic_strain_01 elastic_strain_02 elastic_strain_11 elastic_strain_12 elastic_strain_22 d'
  [../]
  [checkpoint]
      type = Checkpoint
...
# Note: For steady-state static solve, there is no time-dependent dissipation
# Darcy viscous dissipation = 0 for static solve (no time integration)
###############################################################################
[Postprocessors]
