...
#
# All non-archive case directories under 3d_solid/ are pulled. Edit
# SUBDIRS below to change the selection.
#
# Default destination:
#   /Volumes/One Touch/Research/PulsePowerFracturing/cmame_revision/3d_solid
...
REMOTE_ROOT="/scratch2/10024/zhaochun/projects/farms_cdms_04192026/pulsepower/cmame_revision/3d_solid"
DEFAULT_DEST="/Volumes/One Touch/Research/PulsePowerFracturing/cmame_revision/3d_solid"
