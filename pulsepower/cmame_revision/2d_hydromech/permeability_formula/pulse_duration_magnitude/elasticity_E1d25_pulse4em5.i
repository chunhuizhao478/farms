...
[MultiApps]
  [fracture]
    ...
    input_files = fracture_E1d25_pulse4em5.i
...
[Outputs]
  [./exodus]
    ...
    show = 'd vel_x vel_y vel_z pp psie_active_enhanced biot_modulus_aux biot_coefficient_aux porosity_aux bulk_modulus_degraded_aux'
  [../]
  [checkpoint]
      type = Checkpoint
      time_step_interval = 100
