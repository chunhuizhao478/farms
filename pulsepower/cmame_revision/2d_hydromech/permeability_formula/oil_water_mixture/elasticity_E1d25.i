...
#----------------------------------------------------#
fluid_density = 850         # kg/m^3, ~30 deg API crude (Batzle & Wang 1992)
#biot_coefficient = ${fparse 1 - K/K_s}
fluid_bulk_modulus = 1.5e9  # Pa,    ~30 deg API crude at reservoir T,P (Batzle & Wang 1992)
viscosity = 5e-2            # Pa.s,  light crude at reservoir T (Batzle & Wang 1992)
porosity = 0.008
