...
# (tips every 45 deg around the origin). Stripe dimensions match the benchmark:
# full length 0.005 m, full width 4e-4 m, centered at origin. The 0 deg and
# 90 deg stripes are the benchmark's box 1 and box 2; 45 deg and 135 deg are
# the additional rotated stripes.
