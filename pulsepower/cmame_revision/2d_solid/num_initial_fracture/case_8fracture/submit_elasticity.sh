...
# Run the simulation
ibrun /scratch/10024/zhaochun/projects/farms_cdms_04192026/farms-opt -i /scratch/10024/zhaochun/projects/farms_cdms_04192026/pulsepower/cmame_revision/2d_solid/num_initial_fracture/case_8fracture/elasticity.i --allow-unused
