...
# Run the simulation
ibrun /scratch2/10024/zhaochun/projects/farms_cdms_04192026/farms-opt -i /scratch2/10024/zhaochun/projects/farms_cdms_04192026/pulsepower/cmame_revision/2d_solid/num_initial_fracture/case_6fracture/elasticity.i --allow-unused
