...
#   benchmark/
#   no_weak_point/
#   no_weak_point_weibull_strength/shape{5,10,15}/
#   num_initial_fracture/case_{2,6,8}fracture/
#
# Usage:
...
#   ./submit_all.sh benchmark       # only submit cases matching 'benchmark'
#   ./submit_all.sh num_initial     # only submit cases matching 'num_initial'
#
# Artifacts:
#   submitted_jobs.txt  — JOBID:case_path for each successful submission.
#                         Used by monitor/cancel hints below and by
#                         sync_results.sh on the local side.
# =============================================================================
...
# Persist job IDs so sync_results.sh (or manual cancel/squeue) can use them.
