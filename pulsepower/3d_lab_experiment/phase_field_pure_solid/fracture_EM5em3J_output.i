...
# This parameter will be passed from elasticity.i via cli_args
eta_viscosity = 1e-5
...
[Kernels]
  ...
  [source]
    ...
    free_energy = psi
  []
  # Rate-dependent viscous resistance (Hofacker & Miehe 2012)
  # Adds eta * (d - d_old) / dt to phase field equation
  # Prevents spurious damage erosion from reflected waves
  [viscous_resistance]
