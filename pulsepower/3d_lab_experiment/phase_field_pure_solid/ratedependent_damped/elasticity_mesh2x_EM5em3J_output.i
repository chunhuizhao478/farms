...
hht_alpha = 0.1 # Try -0.05 if damage erosion persists with rate-dependent formulation
#----------------------------------------------------#

[MultiApps]
  [fracture]
    type = TransientMultiApp
    input_files = fracture_mesh2x_EM5em3J_output.i
...
[Outputs]
  [./exodus]
    ...
    show = 'd stress_00 stress_01 stress_02 stress_11 stress_12 stress_22'
  [../]
  [checkpoint]
      type = Checkpoint
