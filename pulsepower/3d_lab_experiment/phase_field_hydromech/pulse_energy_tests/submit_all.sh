#!/bin/bash
# =============================================================================
# Submit every Frontera job under pulse_energy_tests/ in one shot.
#
...
#
# Cases discovered today (mesh2x, normal-strain Heider 2021 permeability):
#   case_E5J/        (EM=0.005, undrained borehole)
#   case_E15J/       (EM=0.015, undrained borehole)
#   case_E25J/       (EM=0.025, undrained borehole)
#
# Usage:
...
#   ./submit_all.sh case_E5J        # only submit cases matching 'case_E5J'
#
# Artifacts:
