...
file_path1 = global_path + "/mshfiles/coarse/multifaults_coarse_s.msh"
file_path2 = global_path + "/mshfiles/coarse/network_coarse_s.msh"
txt_elems_path = global_path + "/elemdata/coarse/elem_ind_s.txt"
txt_ids_path = global_path + "/elemdata/coarse/elem_ids_s.txt"
txt_surround_path = global_path + "/elemdata/coarse/elem_surroundingblocks_s.txt"
txt_block_pairs = global_path + "/elemdata/coarse/elem_blockpairs_bruteforce_s.txt"

csv_file_path = global_path + "/elemdata/coarse/area_s.csv"

png1_file_path = global_path + "/elemdata/coarse/1stptr_s.png"
png2_file_path = global_path + "/elemdata/coarse/lineplot_s.png"

#
txt_mat_surf_ptr_all = global_path + "/elemdata/coarse/mat_surf_ptr_all_s.txt"
txt_mat_surf_connect_all = global_path + "/elemdata/coarse/mat_surf_connect_all_s.txt"
txt_mat_surf_triacoordall = global_path + "/elemdata/coarse/mat_surf_triacoordall_s.txt"
txt_mat_surf_trialinesegmentall = global_path + "/elemdata/coarse/mat_surf_trialinesegmentall_s.txt"
