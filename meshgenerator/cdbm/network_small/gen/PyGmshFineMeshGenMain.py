...
file_path1 = global_path + "/mshfiles/fine/multifaults_fine.msh"
file_path2 = global_path + "/mshfiles/fine/network_fine.msh"
txt_elems_path = global_path + "/elemdata/fine/elem_ind.txt"
txt_ids_path = global_path + "/elemdata/fine/elem_ids.txt"
txt_surround_path = global_path + "/elemdata/fine/elem_surroundingblocks.txt"
txt_block_pairs = global_path + "/elemdata/fine/elem_blockpairs_bruteforce.txt"

csv_file_path = global_path + "/elemdata/fine/area.csv"

png1_file_path = global_path + "/elemdata/fine/1stptr.png"
png2_file_path = global_path + "/elemdata/fine/lineplot.png"

#
coarse_mat_surf_ptr_all            = np.loadtxt(global_path + "/elemdata/coarse/mat_surf_ptr_all.txt")
coarse_mat_surf_connect_all        = np.loadtxt(global_path + "/elemdata/coarse/mat_surf_connect_all.txt")
coarse_mat_surf_triacoordall       = np.loadtxt(global_path + "/elemdata/coarse/mat_surf_triacoordall.txt")
coarse_mat_surf_trialinesegmentall = np.loadtxt(global_path + "/elemdata/coarse/mat_surf_trialinesegmentall.txt")
...
mat_connect_corner, mat_connect_surf, mat_connect_lineendptrs, additional_mats =  efunc.gmsh_add_points_2nd(array_coord=array_coord, 
                                                                                                            mat_surf_ptr=coarse_mat_surf_ptr_all,
                                                                                                            mat_surf_connect=coarse_mat_surf_connect_all,
                                                                                                            mat_surf_trialinesegmentall=coarse_mat_surf_trialinesegmentall,
                                                                                                            mat_connect_additional = None,
                                                                                                            lc2=lc1,
                                                                                                            lc3=lc3,
                                                                                                            case_flag=case_flag,
                                                                                                            meshtype = "createfine")
...
arr_surface,arr_additional_surface = efunc.gmsh_add_surfaces_fine_mesh(mat_surface_lineloop=mat_surface_lineloop,
...
mat_egelem_phyname, mat_surf_phyname, mat_egelem_phyname_additional, mat_surface_phyname_additional = efunc.gmsh_add_physical_entities_fine_mesh(arr_elem_corner=arr_elem_corner, 
...
mat_surf_ptr_all, mat_surf_connect_all, mat_surf_triacoordall, mat_surf_trialinesegmentall, mat_ptrs_additional, mat_connect_additional = efunc.meshio_save_network_info_fine_mesh(file_path1=file_path1,
