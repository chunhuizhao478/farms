...
// Volume after Boolean operation (for reference)
If (#all_vols[] > 0)
  Printf("Main volume: Volume %g", all_vols[0]);
Else
...
If (#left_support_surfs[] > 0)
  Printf("Left support surface: Surface %g", left_support_surfs[0]);
EndIf
...
If (#right_support_surfs[] > 0)
  Printf("Right support surface: Surface %g", right_support_surfs[0]);
EndIf
...
If (#loading_surfs[] > 0)
  Printf("Loading surface: Surface %g", loading_surfs[0]);
EndIf
