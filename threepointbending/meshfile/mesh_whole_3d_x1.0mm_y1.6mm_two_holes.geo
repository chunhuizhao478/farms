...
dx_left = 0.002;     // Left hole: horizontal distance from notch tip (3 mm)
dx_right = 0.002;    // Right hole: horizontal distance from notch tip (3 mm)

// Vertical offset from notch tip (same for both holes by default)
dy_left = 0.0036;    // Left hole: vertical distance from notch tip (1.6 mm)
dy_right = 0.0036;   // Right hole: vertical distance from notch tip (1.6 mm)

// Hole geometry (can be different for each hole)
hole_radius_left = 0.001;   // Left hole radius (1 mm)
hole_radius_right = 0.001;  // Right hole radius (1 mm)
