#!/bin/bash
#SBATCH -J 3dptrbend_whole_x1.75mm_y1.6mm        # Job name
#SBATCH -o 3dptrbend_whole_x1.75mm_y1.6mm.o%j    # Name of stdout output file
#SBATCH -e 3dptrbend_whole_x1.75mm_y1.6mm.e%j    # Name of stderr error file
