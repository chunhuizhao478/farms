...
for index_i in range(num_end+1):
    ...
    #load file
    # datafile_time_h = np.loadtxt("./data/febealg/data_out_3d_febealgv2dot2_200m_"+str(int(file_num_i))+".txt", skiprows=1, delimiter=',')
    datafile_time_i = np.loadtxt("./data/data_3d_100m_"+str(int(file_num_i))+".txt", skiprows=1, delimiter=',')
    # datafile_time_j = np.loadtxt("./data/febealg/data_out_3d_febealgv2dot1_100m_"+str(int(file_num_i))+".txt", skiprows=1, delimiter=',')
...
plt.figure()
# plt.plot(time[1:],traction_strike_0[1:],'m--',label="FARMS3D-200m-ApplyBC-theta-first-order, theta updated outside loop")
plt.plot(time[1:],traction_strike[1:],'b--',label="FARMS3D-100m-ApplyBC")
# plt.plot(time[1:],traction_strike_2[1:],'k--',label="FARMS3D-100m-ApplyBC-theta-exact-form,  theta updated inside loop")
plt.plot(timehist_strikeFaultMod100m,traction_strikeFaultMod100m,'r-',label='SPECFEM3D-100m')
...
plt.figure()
# plt.plot(time[1:],sliprate_strike_0[1:],'m--',label="FARMS3D-200m-ApplyBC-theta-first-order, theta updated outside loop")
plt.plot(time[1:],sliprate_strike[1:],'b--',label="FARMS3D-100m-ApplyBC")
# plt.plot(time[1:],sliprate_strike_2[1:],'k--',label="FARMS3D-100m-ApplyBC-theta-exact-form,  theta updated inside loop")
plt.plot(timehist_strikeFaultMod100m,sliprate_strikeFaultMod100m,'r-',label='SPECFEM3D-100m')
...
plt.figure()
# plt.plot(time[1:],statevar_log_0[1:],'m--',label="FARMS3D-200m-ApplyBC-theta-first-order, theta updated outside loop")
plt.plot(time[1:],statevar_log[1:],'b--',label="FARMS3D-100m-ApplyBC")
# plt.plot(time[1:],statevar_log_2[1:],'k--',label="FARMS3D-100m-ApplyBC-theta-exact-form,  theta updated inside loop")
plt.plot(timehist_strikeFaultMod100m,statevar_strikeFaultMod100m,'r-',label='SPECFEM3D-100m')
...
plt.figure()
# plt.plot(time[1:],slip_strike_0[1:],'m--',label="FARMS3D-200m-ApplyBC-theta-first-order, theta updated outside loop")
plt.plot(time[1:],slip_strike[1:],'b--',label="FARMS3D-100m-ApplyBC")
# plt.plot(time[1:],slip_strike_2[1:],'k--',label="FARMS3D-100m-ApplyBC-theta-exact-form, theta updated inside loop")
plt.plot(timehist_strikeFaultMod100m,slip_strikeFaultMod100m,'r-',label='SPECFEM3D-100m')
