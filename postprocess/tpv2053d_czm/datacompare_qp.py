...
for i in range(num_of_file):
    ...
    farms_slip_path = "./farms_data_elemental/local_shear_jump_strike"+str(xcoord_i)+"_dip"+str(zcoord_i)+".txt"
    farms_sliprate_path = "./farms_data_elemental/local_shear_jump_rate_strike"+str(xcoord_i)+"_dip"+str(zcoord_i)+".txt"
    farms_traction_path = "./farms_data_elemental/local_shear_traction_strike"+str(xcoord_i)+"_dip"+str(zcoord_i)+".txt"
