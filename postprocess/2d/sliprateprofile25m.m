...
%moose results
data2 = load("./files/25m_922_uguca_setup/sliprate.txt");
x2 = load("./files/25m_922_uguca_setup/interface_coordx.txt");

filename2 = 'sliprate25m.gif';
for i = 1:40
figure(1);
...
hold off;
xlim([-15e3 15e3])
legend('uguca-25m','moose-25m','location','northeast',FontSize=10)
