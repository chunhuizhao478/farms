...
%moose results
% data0 = load("./files/100m_919_fixnormal/sliprate.txt");
% x0 = load("./files/100m_919_fixnormal/interface_coordx.txt");
% 
data2 = load("./files/50m_921_damp05/sliprate.txt");
x2 = load("./files/50m_921_damp05/interface_coordx.txt");
% 
...
% plot(linspace(-36000,36000,360*2)',data2uguca(i,:)*2,'-k');hold on;
% plot(x0,data0(4*i-3,:),'-c'); hold on;
...
hold off;
xlim([-2.5e3 2.5e3])
% legend('uguca-25m','uguca-50m','uguca-100m','moose-100m',FontSize=10)
