...
% 
% data2 = load("./files/100m_920_dampcomp_0dot4/sliprate.txt");
% x2 = load("./files/100m_920_dampcomp_0dot4/interface_coordx.txt");
% 
...
plot(x5,data5(4*i-3,:),'-k'); hold on;
hold off;
xlim([-15e3 15e3])
legend('uguca-100m','MOOSE-100m-damp-1.0',FontSize=10)
