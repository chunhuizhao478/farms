...
% data1uguca = load('./TPV103_Nx/TPV103_Nx1440_s2.00_tf0.35_npc1-DataFiles/vel0.txt');

data2uguca = load('./TPV103_Nx/TPV103_Nx720_s2.00_tf0.35_npc1-DataFiles/vel0.txt');
...
hold off;
xlim([-15e3 15e3])
legend('uguca-100m','moose-100m','location','northeast',FontSize=10)
