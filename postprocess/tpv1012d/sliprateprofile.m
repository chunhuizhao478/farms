...
data3uguca = load("./TPV101_Nx/TPV101_Nx1440_s2.00_tf0.35_npc1/TPV101_Nx1440_s2.00_tf0.35_npc1-DataFiles/vel0.txt");
...
plot(linspace(-35975,35975,720*2)',data3uguca(i,:)*2,'-b');hold on;
