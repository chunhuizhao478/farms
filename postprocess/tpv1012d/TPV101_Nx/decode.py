...
# test case
full_path = "./TPV101_Nx1440_s2.00_tf0.35_npc1/TPV101_Nx1440_s2.00_tf0.35_npc1-DataFiles" #50m

veldata = read_full_data(full_path+"/top_velo_0.out", 1440, 149)

dispdata = read_full_data(full_path+"/top_disp_0.out", 1440, 149)
