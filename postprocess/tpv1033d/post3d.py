...
time_moose = np.loadtxt("./files/100m_928/time.txt")

sliprate_moose0 = np.loadtxt("./files/100m_928/sliprate_0strike0dot75dip.txt")
sliprate_moose1 = np.loadtxt("./files/100m_928/sliprate_neg9strike0dot75dip.txt")
sliprate_moose2 = np.loadtxt("./files/100m_928/sliprate_pos9strike0dot75dip.txt")
