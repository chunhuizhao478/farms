...
lc_fault = 1250;    // target fine size near fault (inner region)
Fault_length        = 45e3;
Fault_width         = 20e3;
Fault_dip           = 90*Pi/180.;
transition_length   = 2250; //0.25e3;   // inner region halo around fault <- change it back if you want smaller inner volume
