...
lc_fault = 140;    // target fine size near fault (inner region)

lc_intermediate = 140;  // target size in intermediate region
...
transition_length   = 0.14e3;   // inner region halo around fault

intermediate_length = 0.14e3;     // intermediate transition zone
