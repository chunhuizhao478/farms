...
def main_func(sigmayy, nu, added_normalsts, sigmayy_label, added_normalsts_label, mesh_path):
    ...
    #force the mu_s to be large number
    mu_s = 1e10
    ...
    #save elem ids
    np.savetxt("./case_deltasigma"+str(added_normalsts_label)+"/list_elemid_embeded.txt",
                ind_elem_all_embeded,
                fmt='%i',
                newline=" ")

    #save subdomain id
    np.savetxt("./case_deltasigma"+str(added_normalsts_label)+"/list_subdomainid_embeded.txt",
                ind_subdomainid_all_embeded,
                fmt='%i',
                newline=" ")

    #save property elem csv
    with open("./case_deltasigma"+str(added_normalsts_label)+"/faults_elem_properties.csv", 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
