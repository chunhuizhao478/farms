...
[AuxKernels]
    ...
    [strain_invariant_ratio_aux]
        ...
        execute_on = 'timestep_end'
    []
    #block 1: damagable region
    #block 2: left elastic region
    #block 3: right elastic region
    #cd constant
    [get_cd_block2345]
        type = ConstantAux
...
[Functions]
    #initial shear velocity: 1 mu m / s
    [func_right_bc]
        type = ParsedFunction
        expression = 'if (t>dt, -1e-6 * t, 0)'
        symbol_names = 'dt'
        symbol_values = '5e-9'
    []
[]
...
[Controls] # turns off inertial terms for the FIRST time step
  [./period0]
    type = TimePeriod
    disable_objects = '*/vel_x */vel_y */accel_x */accel_y */inertia_x */inertia_y */bc_load_right_y'
    start_time = -1e-12
    end_time = 5e-9 # dt used in the simulation
  []
[../]
