...
[Materials]
    ...
    []
    [strain]
        type = FarmsComputeLagrangianStrain
        large_kinematics = true
    ...
    #     build_param_len_of_fault = 2000
    #     build_param_use_initial_damage_3D = true
    #     build_param_len_of_fault_dip = 1000
    ...
    #     initial_stress = 'func_neg_xx_stress 0 0  
    #                       0 func_neg_yy_stress 0  
