...
[Materials]
    ...
    [dummy_material]
        type = GenericConstantMaterial
        prop_names = 'initial_breakage damage_perturbation initial_shear_stress shear_stress_perturbation'
        prop_values = '0 0 0 0'
    []
[]  
...
[VectorPostprocessors]
    [point_sample]
      ...
      functors = 'vel_x vel_y disp_x disp_y B alpha_damagedvar xi'
      positions = 'pos'
      sort_by = x
      execute_on = TIMESTEP_END
    []
