...
[Mesh]
    ...
    [./mark_block_1]
        ...
        input = msh
        location = inside
        bottom_left = '-8000 -8000 0'
        top_right = '8000 8000 0'
        block_id = 2
    []
    [./mark_block_2]
        type = SubdomainBoundingBoxGenerator
...
[AuxKernels]
    ...
    #block 2: transition region where the damage/breakage evolution parameters decreases with distance away from block3 to block1
    #block 3: inner block where damage is activated
    #cd constant
    [get_cd_block1]
        type = ConstantAux
...
#define changing (with distance) function for damage/breakage
