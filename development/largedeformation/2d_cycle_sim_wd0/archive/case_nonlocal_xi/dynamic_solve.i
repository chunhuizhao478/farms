...
[Kernels]
    ...
    [react_nonlocal]
        ...
        block = '1 2'
    []
    # The c is of dimension length squared, so c^1/2 is characteristic length
    # we assume the length scale is equal to 1 times the element size 1*5e-4 = 5e-4
    # so the c is 5e-4^2 = 2.5e-7
    # other parameters
    # l = 100 , c = l^2 = 1.5625e-8
    [diffusion_nonlocal]
        type = CoefDiffusion
        variable = nonlocal_xi
        coef = 10000
...
[Outputs]
    [./exodus]
      ...
      show = 'vel_x vel_y initial_damage alpha_damagedvar_aux B_damagedvar_aux strain_invariant_ratio_aux pk2_stress_00 pk2_stress_11 pk2_stress_01 nonlocal_xi'
    [../]
    [./csv]
      type = CSV
