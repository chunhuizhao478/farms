...
nums = ['11','12','13','14','15','16','21','22','23','24','25','26','31','32','33','34','35','36','41','42','43','44','45','46','51','52','53','54','55','56','61','62','63','64','65','66'];
for num = 1:length(nums)/2
    ...
    string_minus_epse13 = 'eps13p_inc - eps13t + eps13p_pre';
    string_minus_epse23 = 'eps23p_inc - eps23t + eps23p_pre';
    ...
    string_minus_epseI2 = '(minus_eps11e)^2 + 2*(minus_eps12e)^2 + 2*(minus_eps13e)^2 + (minus_eps22e)^2 + 2*(minus_eps23e)^2 + (minus_eps33e)^2';
    string_minus_4epse12 = '4*eps12p_inc - 4*eps12t + 4*eps12p_pre';
    string_minus_4epse13 = '4*eps13p_inc - 4*eps13t + 4*eps13p_pre';
    string_minus_4epse23 = '4*eps23p_inc - 4*eps23t + 4*eps23p_pre';
    ...
    v = replace(v,string_minus_epse13,'minus_eps13e');
    v = replace(v,string_minus_epse23,'minus_eps23e');
    ...
    v = replace(v,string_minus_4epse13,'4*minus_eps13e');
    v = replace(v,string_minus_4epse23,'4*minus_eps23e');
