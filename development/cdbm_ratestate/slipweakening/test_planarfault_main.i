...
# mu_d = 0.55
# For Main Fault, 
# mu = shear stress / normal stress = 30e6 / 50e6 = 0.6
# mu_s = 0.78
# S = ( mu_s - mu ) / ( mu - mu_d ) = ( 0.78 - 0.6 ) / ( 0.6 - 0.55) = 0.2
# Frictional Length Scale L = G Dc / ( ( mu_s - mu_d ) sigma_yy ) = 32.04e9 * 0.4 / (( 0.78 - 0.55) * 50e6) = 1114m
# Use mesh size = 50m
##########################################################
