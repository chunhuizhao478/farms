...
[Mesh]
    [./msh]
        ...
        file =  '../../../meshgenerator/cdbm/planarfault_shrift_quicktest/planarfault_shrift.msh'
    []
    [./new_block_1]
        type = ParsedSubdomainMeshGenerator
        input = msh
        combinatorial_geometry = 'y<-250'
        block_id = 1
    []
    [./split]
  ...
  [Functions]
    ...
    #since it's driven by pressure, the initial shear stress is the same across the domain
