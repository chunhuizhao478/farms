...
plt.text(vs_val + x_off, y_vs, f"Vs = {vs_val:.2f} km/s", color='r', va='center', ha='center',
         rotation=90, fontsize=12,
         bbox=dict(facecolor='white', alpha=0.6, edgecolor='none'))
plt.text(vp_val + x_off, y_vp, f"Vp = {vp_val:.2f} km/s", color='b', va='center', ha='center',
         rotation=90, fontsize=12,
         bbox=dict(facecolor='white', alpha=0.6, edgecolor='none'))
plt.text(rho_val + x_off, y_rho, f"ρ = {rho_val:.2f} g/cc", color='k', va='center', ha='center',
         rotation=90, fontsize=12,
         bbox=dict(facecolor='white', alpha=0.6, edgecolor='none'))
