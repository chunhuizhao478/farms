 ...
 *   Y in [-transition_length_neg, +transition_length_pos]
 *   Z in [0, -Fault_width - transition_length]
 * with transition_length_pos = 8 km (tensile side), transition_length_neg = 2 km.
 */
...
Y_inner_min = -transition_length_neg;  // -2 km
Y_inner_max =  transition_length_pos;  // +8 km (asymmetric, extended on tensile side)
Z_inner_top = 0;
