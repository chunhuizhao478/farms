...
overpressure_depth_A = 6000 #overpressure depth A (m) - where transition begins
overpressure_depth_B = 8000 #overpressure depth B (m) - where transition ends
overpressure_rho_ref = 2900 #reference rock density for overpressure (kg/m^3) - TPV32 final value at 15 km
##------------------------------------------------------------------##
...
[Kernels]
  ...
  [gravity_z]
    ...
    overpressure_rho_ref = ${overpressure_rho_ref}
  []
[]
