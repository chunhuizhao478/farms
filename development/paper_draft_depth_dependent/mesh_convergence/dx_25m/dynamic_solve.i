...
##element size
elem_size = 25 #!!! element size near the fault, need to be consistent with the mesh file
...
checkpoint_time_step_interval = 160 #time step interval for checkpoint output
