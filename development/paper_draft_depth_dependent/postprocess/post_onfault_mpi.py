...
TARGET_POINTS: List[Tuple[float, float, float]] = [
    ...
    (4000, 0, -15000),
    (8000, 0, -15000),
    (12000, 0, -15000), #15000m depth
]

# Case list (copy/adapt from your post_onfault.py)
COMMON_PATH = "/scratch1/10024/zhaochun/projects/farms_benchmark_09192025/development/paper_draft_depth_dependent/"
CASES = [
    {
        ...
        "dt": 0.005,
        "output_dir": COMMON_PATH +"./postprocess/case1f_eps1em7_on_fault/",
    },
    {
        "name": "dynamic_solve_csv_main_fault",
        ...
        "index": {"start": 2, "end": 2400, "step": 2, "pad": 4},
        "dt": 0.005,
        "output_dir": COMMON_PATH +"./postprocess/case2f_eps1em8_on_fault/",
    },
    {
        "name": "dynamic_solve_csv_main_fault",
        ...
        "index": {"start": 2, "end": 2400, "step": 2, "pad": 4},
        "dt": 0.005,
        "output_dir": COMMON_PATH +"./postprocess/case3f_eps1em7_on_fault/",
    },
]
