...
##mesh domain
nonlocal_eqstrain_blocks = '100 200 10 11'
...
[Mesh]
  [./msh]
    ...
    file = '../../mesh/tpv26_100m_nonlocal_occ_40kmfault_nonlocalextend.msh'
  []
  [./new_block_1]
...
[Materials]
  ...
  #LOCAL MODEL: all blocks use local xi, no nonlocal averaging
...
[UserObjects]
  ...
  [./init_sol_components]
    ...
    mesh = '../static_solve/static_solve_normal2x_out.e'
    ...
    execute_on = 'INITIAL'
  [../]
  #LOCAL MODEL: nonlocal averaging user objects disabled
  #here we avoid the cross-fault averaging by defining separate averaging blocks
