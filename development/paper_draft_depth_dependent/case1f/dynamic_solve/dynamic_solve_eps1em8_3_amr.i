...
##mesh domain
nonlocal_eqstrain_blocks = '100 200 10 12 13'

nonlocal_eqstrain_blocks_amr = '10 12 13'
...
ymin_fault = -200
ymax_fault = 200
nonlocal_averaging_length_scale = 300
...
[Mesh]
  [./msh]
    ...
    file = '../../mesh/tpv26_100m_nonlocal_occ_40kmfault_amr.msh'
  []
  [./new_block_1]
...
[Adaptivity]
    ...
    [Indicators]
        [error]
          ...
          variable = alpha_damagedvar_constmonomial_aux
          block = ${nonlocal_eqstrain_blocks_amr}
        []
    []
    [Markers]
        [./error_marker]
        ...
        [./combo]
            type = ComboMarker
            markers = 'error_marker damage_marker'
            block = ${nonlocal_eqstrain_blocks_amr}
       [../]
    []
[]
...
[AuxVariables]
  ...
  []
  #guide amr
  [alpha_damagedvar_constmonomial_aux]
      order = CONSTANT
      family = MONOMIAL
  []
  ###
...
[AuxKernels]
  ...
  [get_alpha_damagedvar]
    ...
    execute_on = 'TIMESTEP_END'
  []
  [get_alpha_damagedvar_constmonomial_aux]
    type = MaterialRealAux
    variable = alpha_damagedvar_constmonomial_aux
    property = alpha_damagedvar
    execute_on = 'TIMESTEP_END'
...
[Materials]
  ...
  [nonlocal_eqstrain_blocks]
    type = ElkNonlocalEqstrainUpdated
    average_UO = eqstrain_averaging_blocks
    block = ${nonlocal_eqstrain_blocks}
  []
...
[UserObjects]
  ...
  [./init_sol_components]
    ...
    mesh = '../static_solve/static_solve_amr_out.e'
