...
thermal_A = 6.3e-27 #Pa^-3 s^-1
thermal_n = 2.5     #dimensionless
thermal_Q = 126e3   #J/mol 
thermal_R = 8.314   #gas constant
thermal_T_name = 'thermal_T' #name of temperature material property
##-------------------------##
...
[AuxKernels]
  ...
  [get_thermal_T]
    type = MaterialRealAux
    variable = thermal_T_aux
    property = ${thermal_T_name}
    execute_on = 'INITIAL'
  []
[]
...
[Materials]
  ...
  [stress_medium_nonlocal]
      ...
      output_properties = 'B alpha_damagedvar xi I1 I2 deviatoric_strain_rate eps_p'
      ...
      thermal_A = ${thermal_A}  #Pa^-3 s^-1
      thermal_n = ${thermal_n}  #dimensionless
      thermal_Q = ${thermal_Q}  #J/mol 
      thermal_R = ${thermal_R}  #gas constant
      thermal_T_name = ${thermal_T_name} #name of temperature material property
      #----------------------------------------------------------------------#
      outputs = exodus
  []
  [dummy_material]
  ...
  #temperature
  [temp_mat]
    type = FarmsFunctionMaterial
    property_name = ${thermal_T_name}
    function = func_temp_profile
  []
[]
...
[Functions]
  ...
  #the temperature is in unit Kelvin
  [./func_temp_profile]
    type = ParsedFunction
    expression = '279.1024 + 0.03982143 * (-z) - 0.000000559524 * (-z) * (-z)'
  []
[]
...
[Outputs]
  [exodus]
    type = Exodus
    execute_on = 'timestep_end'
    show = 'vel_slipweakening_x vel_slipweakening_y vel_slipweakening_z disp_slipweakening_x disp_slipweakening_y disp_slipweakening_z alpha_damagedvar_aux B_aux xi_aux stress_xx stress_yy stress_xy deviatoric_strain_rate_aux eqstrain_nonlocal_aux eqstrain_nonlocal_initial thermal_T_aux eps_p_01'
