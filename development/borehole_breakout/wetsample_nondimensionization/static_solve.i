...
#-------------------------------------------------#
porosity = 0.008
permeability_scalar = ${fparse 1E-20 / (L * L)}
permeability = '${permeability_scalar} 0 0 0 ${permeability_scalar} 0 0 0 ${permeability_scalar}'
fluid_density = 1000
...
#block_ids
#-------------------------------------------------#
# elastic_block_ids = '1 2'
damageable_block_ids = '3'
#-------------------------------------------------#
