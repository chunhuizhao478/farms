...
[AuxKernels]
    ...
    []
    #---------------------------------------------------#
    #test restrict the nonlocal xi to the damageable zone
    [get_nonlocal_xi]
        type = MaterialRealAux
        ...
        block = '3'
    []
    #for elastic domain, the nonlocal xi is minimum value
    [get_nonlocal_xi_elastic]
        type = ConstantAux
        variable = nonlocal_xi
        value = -1.732
        block = '1 2'
...
[MultiApps]
    [./sub_app]
        ...
        positions = '0 0 0'
        input_files = 'dynamic_solve_sub_nonlocal.i'
