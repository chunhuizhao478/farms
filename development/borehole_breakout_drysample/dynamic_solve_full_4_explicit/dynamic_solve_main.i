...
[Kernels]
    ...
    []
    [./mass1]
        type = FluidSolidCouplingExplicit
        variable = porepressure
    [../]
    [./mass2]
        type = PorePressureTimeDerivativeExplicit
        variable = porepressure
    [../]
    [./darcy_flow]
        type = FluidDiffusion
...
[Materials]
    ...
    #
    [damage_mat]
        type = DiffusedDamageBreakageMaterialMainAppExplicit
    ...
    [] 
    [stress_medium]
        type = ComputeLagrangianDamageBreakageStressPK2DiffusedExplicit
        large_kinematics = true
