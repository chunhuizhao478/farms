...
plot_params.ploteveynsteps = 50;

%% stress-strain
% Load files
ss_1 = readmatrix("stress_strain_fh-0.04dt_0.001.txt");
ss_2 = readmatrix("stress_strain_fh-0.06dt_0.001.txt");
...
plot_params.legend_labels = {'applied strain: 0.04', 'applied strain: 0.06', 'applied strain: 0.08'};
...
d_1 = readmatrix("alpha_fh-0.04dt_0.001.txt");
d_2 = readmatrix("alpha_fh-0.06dt_0.001.txt");
d_3 = readmatrix("alpha_fh-0.08dt_0.001.txt");
...
%% xi-damage
% Load files
xi_1 = readmatrix("xi_fh-0.04dt_0.001.txt");
xi_2 = readmatrix("xi_fh-0.06dt_0.001.txt");
xi_3 = readmatrix("xi_fh-0.08dt_0.001.txt");
