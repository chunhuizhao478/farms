...
[Mesh]
  file = ../static_solve/test_borehole_main_out.e
[]
...
[AuxVariables]
  ...
  [./xi_old]
      order = CONSTANT
      family = MONOMIAL
      initial_from_file_var = xi_saved
      initial_from_file_timestep = LATEST
  []
  [./I2_old]
      order = CONSTANT
  ...
  [initial_stress_xx]
    order = CONSTANT
    family = MONOMIAL
    initial_from_file_var = stress_xx_saved
    initial_from_file_timestep = LATEST
  []
  [initial_stress_xy]
    order = CONSTANT
    family = MONOMIAL
    initial_from_file_var = stress_xy_saved
    initial_from_file_timestep = LATEST
  []
  [initial_stress_yy]
    order = CONSTANT
    family = MONOMIAL
    initial_from_file_var = stress_yy_saved
    initial_from_file_timestep = LATEST
  []
[]
