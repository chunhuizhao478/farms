...
[Mesh]
  [./msh]
      ...
      file =  '../../../../../meshgenerator/cdbm/borehole_debug/borehole_wofaults.msh'
  []
  [./subdomain_id] 
      input = msh
...
[Materials]
  ...
  [./static_initial_stress_tensor_slipweakening]
      ...
      tensor_functions = 'func_stress_xx              func_frank_case               func_initial_stress_00 
                          func_frank_case              func_stress_yy               func_initial_stress_00
...
[UserObjects]
  ...
  #   mesh = ./static_solve/test_borehole_main_out.e
  #   system_variables = stress_xx_saved_nodal
  #   execute_on = 'INITIAL TIMESTEP_BEGIN'
  #   timestep = LATEST
  #   force_preaux = true
  # []
  ...
  #   type = SolutionUserObject
  #   mesh = ./static_solve/test_borehole_main_out.e
  #   system_variables = stress_xy_saved_nodal
  #   execute_on = 'INITIAL TIMESTEP_BEGIN'
  #   timestep = LATEST
  #   force_preaux = true
  # []
  ...
  #   type = SolutionUserObject
  #   mesh = ./static_solve/test_borehole_main_out.e
  #   system_variables = stress_yy_saved_nodal
  #   execute_on = 'INITIAL TIMESTEP_BEGIN'
  #   timestep = LATEST
  #   force_preaux = true
  # []
