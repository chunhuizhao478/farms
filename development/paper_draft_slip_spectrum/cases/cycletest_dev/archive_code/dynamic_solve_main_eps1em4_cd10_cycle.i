...
[Controls] # turns off inertial terms for the SECOND time step
  ...
  [./velocity_switch]
    ...
    postprocessor = maxvelmag_filtered
    comparison_type = less_equal
    threshold = 5e-3
    enable_objects = 'Kernels/rad_damp_x Kernels/rad_damp_y'
    disable_objects = 'Kernels/inertia_x Kernels/inertia_y BCs/damp_left_x BCs/damp_left_y BCs/damp_right_x BCs/damp_right_y BCs/damp_top_x BCs/damp_top_y BCs/damp_bottom_x BCs/damp_bottom_y'
  []
[../]
...
[Postprocessors]
  ...
  []
  [./maxvelmag_filtered]
    type = FarmsFilteredNodalExtremeValue
    variable = vel_mag
    exclude_boundaries = 'top'
  []
[]
...
[Outputs]
    [./exodus]
      ...
      show = 'vel_x vel_y vel_mag alpha_damagedvar_aux B_damagedvar_aux xi_aux nonlocal_xi pk2_stress_01 green_lagrange_elastic_strain_01 plastic_strain_01 total_lagrange_strain_01 deviatroic_strain_rate_aux equiv_plastic_strain equiv_plastic_strain_rate'
    [../]
    [./csv]
        type = CSV
