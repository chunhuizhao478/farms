...
[Mesh]
    ...
    [./box2]
        ...
        input = box
        block_id = 1
        bottom_left = '0 0.024 0'
        top_right = '0.01 0.025 0'
    [] 
    [./extranodeset1]
...
[Controls] # turns off alpha forcing term
  [./period0]
    type = TimePeriod
    disable_objects = '*/forcing_term_alpha'
    start_time = -1e-12
    end_time = 0.11 # dt used in the simulation
  []
[../]
