...
[Functions]
    ...
    [func_strain_xx]
        ...
        solution = init_sol_components
        # execute_on = 'INITIAL'
        from_variable = green_lagrange_elastic_strain_00
    [../]
    [func_strain_xy]
        type = SolutionFunction
        solution = init_sol_components
        # execute_on = 'INITIAL'
        from_variable = green_lagrange_elastic_strain_01
    [../]
    [func_strain_xz]
        type = SolutionFunction
        solution = init_sol_components
        # execute_on = 'INITIAL'
        from_variable = green_lagrange_elastic_strain_02
    [../]
    [func_strain_yy]
        type = SolutionFunction
        solution = init_sol_components
        # execute_on = 'INITIAL'
        from_variable = green_lagrange_elastic_strain_11
    [../]
    [func_strain_yz]
        type = SolutionFunction
        solution = init_sol_components
        # execute_on = 'INITIAL'
        from_variable = green_lagrange_elastic_strain_12
    [../]
    [func_strain_zz]
        type = SolutionFunction
        solution = init_sol_components
        # execute_on = 'INITIAL'
        from_variable = green_lagrange_elastic_strain_22
    [../]       
[]
...
[UserObjects]
    [./init_sol_components]
      ...
      system_variables = 'disp_x disp_y initial_damage green_lagrange_elastic_strain_00 green_lagrange_elastic_strain_01 green_lagrange_elastic_strain_02 green_lagrange_elastic_strain_11 green_lagrange_elastic_strain_12 green_lagrange_elastic_strain_22'
      timestep = LATEST
      force_preaux = true
    [../]
[]
