...
[Materials]
    ...
    [damage_mat]
        ...
        output_properties = 'alpha_damagedvar B_damagedvar xi_0 shear_modulus'
        outputs = exodus
        block = '1 2'
...
[Outputs]
    [./exodus]
      ...
      show = 'vel_x vel_y initial_damage alpha_damagedvar_aux B_damagedvar_aux strain_invariant_ratio_aux pk2_stress_00 pk2_stress_11 pk2_stress_01 xi_0 shear_modulus'
    [../]
    [./csv]
      type = CSV
...
[Problem]
    ...
    restart_file_base = dynamic_solve_restart_2_out_cp/LATEST  # You may also use a specific number here
[]
