function [param] = struct_param_cycleloading(C1,CBH)
...
param.chi = 0.7;           %--  <ratio of two energy state: F_b/F_s = chi < 1>: ensure the energy transition from solid state to granular state.
param.C_d = 30;            %1/s <coefficient gives positive damage   evolution >: refer to "Lyak_BZ_JMPS14_splitstrain" Table 1
param.C_1 = C1;            %1/s <coefficient of healing for damage evolution>: refer to "Lyakhovsky_2011_Hessian_Matrix" Section 3.4 %%1e-14 %%300
...
param.beta = 0.01;        %--  <coefficient gives width of transitional region>: see P(alpha), refer to "Lyak_BZ_JMPS14_splitstrain" Table 1 %%0.001%%
param.C_B = 300; %1e-5     %1/s <coefficient gives positive breakage evolution >: refer to "Lyak_BZ_JMPS14_splitstrain" Table 1
param.C_BH = CBH;  %1/s <coefficient of healing for breakage evolution>: refer to "Lyakhovsky_Ben-Zion_P14".
