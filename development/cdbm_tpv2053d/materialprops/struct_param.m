function [param] = struct_param(lambda_in,mu_in,xi_o_in)
...
param.lambda_0 = 32.04e9; %Pa  <initial 1st lame constant> refer to "Lyak_BZ_JMPS14_splitstrain" Section 3.1 | 10 ^ 10 | 3.204e10
param.mu_0 = 32.04e9;     %Pa  <initial 2nd lame constant> refer to "Lyak_BZ_JMPS14_splitstrain" Section 3.1 | 10 ^ 10 | 3.204e10
param.xi_0 = -0.7;        %--  <strain invariants ratio: onset of damage evolution>: relate to internal friction angle, refer to "note_mar25"
param.xi_d = -0.7;        %--  <strain invariants ratio: onset of breakage healing>: tunable param, see ggw183.pdf
...
param.C_BH = 10^4;  %1/s <coefficient of healing for breakage evolution>: refer to "Lyakhovsky_Ben-Zion_P14".
