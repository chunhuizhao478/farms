...
# ymin_fault = -1500
# ymax_fault = 1500
nonlocal_averaging_length_scale = 200 #400
nonlocal_averaging_radius = 400 #800
...
# nucl_center_vector = '-16000 0 -10000'
...
[Materials]
  ...
  [stress_medium]
      type = ComputeDamageBreakageStress3DTabularZonesNonlocal
  ...
  [dummy_material]
      ...
      prop_names = 'initial_breakage density'
      prop_values = '0 ${density}'
  []
