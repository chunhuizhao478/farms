...
[Mesh]
  [./msh]
    ...
    file =  '../../../meshgenerator/cdbm/network_vsmall_random/gen/refinedmesh.msh'
  []
  [./subdomain_id] 
  input = msh
...
[Modules/TensorMechanics/CohesiveZoneMaster]
  [./czm_ik]
    boundary = 'czm'
    strain = SMALL
    generate_output='tangent_jump tangent_traction normal_traction'
  [../]
[]
...
[Functions]
  ...
  #pressure
  [func_pressure]
    type = InitialStressXYPressureNetworkLocal
    # type = ConstantFunction
    # value = 0
  []
[]
...
[BCs]
  [./dashpot_top_x]
      ...
      disp_x = disp_x
      disp_y = disp_y
      p_wave_speed = 4740.45 
      shear_wave_speed = 2736.90
      boundary = top
  []
  [./dashpot_top_y]
      type = NonReflectDashpotBC
