...
[Materials]
    ...
    [./strain_from_initial_stress]
        ...
        initial_stress = 'func_xx_stress func_xy_stress 0.0
                         func_xy_stress func_yy_stress 0.0
                         0.0 0.0 func_zz_stress'
...
[Functions]
    [func_yy_stress]
        ...
        expression = '27708.9 * z'
    []
    [func_xx_stress]
        type = ParsedFunction
        # expression = '-1 * ( 0.926793 * ( (-2700 * 9.81 * (-z)) + (1000 * 9.81 * (-z)) ) - (1000 * 9.81 * (-z)) )'        
        expression = '25265.8 * z'
    []
    [func_zz_stress]
        type = ParsedFunction
        # expression = '-2700 * 9.81 * (-z)'  
        expression = '26487 * z'
    []
    [func_xy_stress]
        type = ParsedFunction
