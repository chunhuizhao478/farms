...
param.xi_0 = -1.0;        %--  <strain invariants ratio: onset of damage evolution>: relate to internal friction angle, refer to "note_mar25"
param.xi_d = -1.1;        %--  <strain invariants ratio: onset of breakage healing>: tunable param, see ggw183.pdf
