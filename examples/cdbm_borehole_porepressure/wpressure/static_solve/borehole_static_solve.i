...
[AuxVariables]
  ...
  [./xi_saved]
    ...
    family = MONOMIAL
  [../]
  [./stress_xx_saved_nodal]
    order = FIRST
    family = LAGRANGE
  [../]
  [./stress_xy_saved_nodal]
    order = FIRST
    family = LAGRANGE
  []
  [./stress_yy_saved_nodal]
    order = FIRST
    family = LAGRANGE
  [../]
  [./strain_xx_saved_nodal]
    order = FIRST
    family = LAGRANGE
  [../]
  [./strain_xy_saved_nodal]
    order = FIRST
    family = LAGRANGE
  []
  [./strain_yy_saved_nodal]
    order = FIRST
    family = LAGRANGE
  [../]
  [./xi_saved_nodal]
...
[AuxKernels]
  ...
  [stress_xx_nodal]
    type = ProjectionAux
    variable = stress_xx_saved_nodal
    v = stress_xx_saved
    execute_on = 'LINEAR TIMESTEP_END'
  []
  [stress_xy_nodal]
    type = ProjectionAux
    variable = stress_xy_saved_nodal
    v = stress_xy_saved
    execute_on = 'LINEAR TIMESTEP_END'
  []
  [stress_yy_nodal]
    type = ProjectionAux
    variable = stress_yy_saved_nodal
    v = stress_yy_saved
    execute_on = 'LINEAR TIMESTEP_END'
  []
[]
