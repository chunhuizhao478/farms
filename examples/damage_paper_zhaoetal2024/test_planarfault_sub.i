[Mesh]
    [./msh]
        ...
        file =  'mesh/planarfault2_uniform_adaptive.msh'
    []
    [./new_block_1]
  ...
  [Kernels]
    ...
    [./B_forcing_func]
        ...
        #alpha_cr is a closed form whose coefficients bake in the elastic moduli.
        #This case runs lambda_o = shear_modulus_o = 3.204e10 (see GlobalParams above),
        #so it must use the matching calibration. Without this line the kernel falls
        #back to its 2.73e9 default and damage caps at 0.952169427 instead of 1.0.
