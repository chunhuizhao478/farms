...
[Mesh]
  ...
  [Materials]
    ...
    [./fractal_shear_stress_mainfault]
        ...
        csv_file = 'examples/benchmark_tpv142D/tpv142D_parametric_study/fractal_stress_generation/main_fault_fractal_stress_5.csv'
    []
    [./fractal_shear_stress_branchfault]
        type = FractalShearStress
        boundary = 'Block300_Block400'
        csv_file = 'examples/benchmark_tpv142D/tpv142D_parametric_study/fractal_stress_generation/branch_fault_fractal_stress_5.csv'
    []
  []
  ...
  [Outputs]
    ...
    [csv]
      ...
      file_base = '/scratch1/10024/zhaochun/projects/farms_benchmark/examples/benchmark_tpv142D/fractal_stress/output_5/tpv142D_tria_5'
    []
  []
