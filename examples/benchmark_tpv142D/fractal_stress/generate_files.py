# Define the template content with placeholders {index} for substitution
template = ("""
...
[Mesh]
  ...
  [Materials]
    ...
    [./fractal_shear_stress_mainfault]
        ...
        csv_file = 'examples/benchmark_tpv142D/tpv142D_parametric_study/fractal_stress_generation/main_fault_fractal_stress_{index}.csv'
    []
    [./fractal_shear_stress_branchfault]
        type = FractalShearStress
        boundary = 'Block300_Block400'
        csv_file = 'examples/benchmark_tpv142D/tpv142D_parametric_study/fractal_stress_generation/branch_fault_fractal_stress_{index}.csv'
    []
  []
...
# Loop from 1 to 100 to generate files with the updated CSV file paths
for i in range(1, 101):
    filename = f"tpv142D_tria_{i}.i"
    with open(filename, "w") as f:
        # Replace the placeholder {index} with the actual index number
