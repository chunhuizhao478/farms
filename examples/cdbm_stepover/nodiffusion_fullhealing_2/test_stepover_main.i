...
[Mesh]
    [./msh]
        ...
        file =  '../../../meshgenerator/cdbm/stepover/step_over.msh'
    []
    [./new_block_1]
        type = ParsedSubdomainMeshGenerator
        input = msh
        combinatorial_geometry = 'x >= -3000 & x<= 5000 & y<=100 & y>=0'
        block_id = 1
    []
    [./new_block_2]
        type = ParsedSubdomainMeshGenerator
        input = new_block_1
        combinatorial_geometry = 'x >= -3000 & x<= 5000 & y<=0 & y>=-100'
        block_id = 2
    []
    [./new_block_3]
      type = ParsedSubdomainMeshGenerator
      input = new_block_2
      combinatorial_geometry = 'x >= 2000 & x<= 10000 & y<=-900 & y>=-1000'
      block_id = 3
    []
    [./new_block_4]
        type = ParsedSubdomainMeshGenerator
        input = new_block_3
        combinatorial_geometry = 'x >= 2000 & x<= 10000 & y<=-1000 & y>=-1100'
        block_id = 4
    []
    [./split]
  ...
  [MultiApps]
    [./sub_app]
        ...
        positions = '0 0 0'
        input_files = 'test_stepover_sub.i'
        execute_on = 'TIMESTEP_BEGIN'
    [../]
  []
