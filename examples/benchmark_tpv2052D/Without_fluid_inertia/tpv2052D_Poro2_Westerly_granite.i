...
[Mesh]
    [./msh]
        ...
        file =  '../With_fluid_inertia/Planar_fault_unstructured_Westerly.msh'
    []
    [subdomain1]
        input = msh
        type = SubdomainBoundingBoxGenerator
        bottom_left = '-11000 -11000 0'
        top_right = '11000 11000 0'
        block_id = 0
    []
    [./new_block_1]
...
[Materials]
    ...
    [biot_modulus]
        ...
        biot_coefficient = 0.449
        solid_bulk_compliance = 1.41243e-11
        fluid_bulk_modulus = 2.25e9
    []
    [permeability]
        type = PorousFlowPermeabilityConst
        permeability = '3.948e-19 0 0   0 3.948e-19 0   0 0 3.948e-19'
    []
    [./czm_mat]
