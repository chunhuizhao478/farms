...
[Actions/PoroCohesiveZoneAction]
    [./czm_ik]
        ...
        save_in_slave  = 'resid_FIRSTary_x  resid_FIRSTary_y'   
    [../]
[]
...
[Materials]
    ...
    [./czm_mat]
        ...
        jacob_x = resid_primary_x
        jacob_y = resid_primary_y
        react_pressure_x = resid_pressure_x
        react_pressure_y = resid_pressure_y 
        jacob_pressure_x = resid_pressure_x
        jacob_pressure_y = resid_pressure_y 
        react_damp_x = resid_damping_x
        react_damp_y = resid_damping_y
        jacob_damp_x = resid_damping_x
        jacob_damp_y = resid_damping_y
