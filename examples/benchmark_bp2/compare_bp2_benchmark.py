...
benchmark_file2 = "./benchmark_data/bp2-qd-z0km-erickson.txt"
...
if __name__ == "__main__":
    ...
    benchmark2 = load_benchmark_data(benchmark_file2)
    ...
    # Print statistics
    print_comparison_stats(benchmark2, benchmark)

    # Create plots
    print("\nGenerating plots...")
    plot_comparison(benchmark2, benchmark)
    print("Done!")
