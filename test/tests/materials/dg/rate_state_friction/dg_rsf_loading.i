# DGRateStateFrictionMaterial Test with Loading
# Proper test with plate-rate loading to drive slip
...
[BCs]
  # Plate-rate loading: Vp = 1e-9 m/s
  [left_far]
