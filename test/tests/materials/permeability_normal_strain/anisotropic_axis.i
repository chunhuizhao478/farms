# Unit test: Heider (2021) normal-strain permeability, anisotropic branch,
# axis-aligned damage gradient.
#
# Geometry and loading identical to isotropic_axis.i but with
# permeability_anisotropic = true.
# n_d = (1,0,0) -> projector I - n_d (x) n_d = diag(0,1,1).
# Expected at the QP (d_qp ~= 0.7):
#   K_xx = k0
